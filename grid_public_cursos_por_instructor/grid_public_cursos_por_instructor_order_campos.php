...
<?php
   ...
   $Ord_Cmp = new grid_public_cursos_por_instructor_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_public_cursos_por_instructor_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_public_cursos_por_instructor']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_public_cursos_por_instructor']['ordem_select_orig'] = array();
   }
   ...
   if ($use_alias == "S")
   {
       $tab_def_campos['cur_nombre_curso'] = "cur_nombre_curso";
   }
   else
   {
       $tab_def_campos['cur_nombre_curso'] = "cur.nombre_curso";
   }
   $tab_labels["cur_nombre_curso"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_public_cursos_por_instructor']['labels']["cur_nombre_curso"])) ? $_SESSION['sc_session'][$sc_init]['grid_public_cursos_por_instructor']['labels']["cur_nombre_curso"] : " Cursos";
   $tab_ger_campos['cpi_id'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['cpi_id'] = "cpi_id";
   }
   else
   {
       $tab_def_campos['cpi_id'] = "cpi.id";
   }
   $tab_labels["cpi_id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_public_cursos_por_instructor']['labels']["cpi_id"])) ? $_SESSION['sc_session'][$sc_init]['grid_public_cursos_por_instructor']['labels']["cpi_id"] : "Id";
   $tab_ger_campos['instructor'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['instructor'] = "instructor";
   }
   else
   {
       $tab_def_campos['instructor'] = "i.nombre || ' ' || i.apellido";
   }
   $tab_labels["instructor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_public_cursos_por_instructor']['labels']["instructor"])) ? $_SESSION['sc_session'][$sc_init]['grid_public_cursos_por_instructor']['labels']["instructor"] : "Instructores";
   $tab_ger_campos['cpi_fecha_asignacion'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['cpi_fecha_asignacion'] = "cpi_fecha_asignacion";
   }
   else
   {
       $tab_def_campos['cpi_fecha_asignacion'] = "cpi.fecha_asignacion";
   }
   $tab_labels["cpi_fecha_asignacion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_public_cursos_por_instructor']['labels']["cpi_fecha_asignacion"])) ? $_SESSION['sc_session'][$sc_init]['grid_public_cursos_por_instructor']['labels']["cpi_fecha_asignacion"] : "Fecha Asignación";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_public_cursos_por_instructor']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_public_cursos_por_instructor']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_public_cursos_por_instructor']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_public_cursos_por_instructor']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_public_cursos_por_instructor']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_public_cursos_por_instructor']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_public_cursos_por_instructor']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_public_cursos_por_instructor']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_public_cursos_por_instructor']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_public_cursos_por_instructor']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_public_cursos_por_instructor']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_public_cursos_por_instructor']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_public_cursos_por_instructor_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_public_cursos_por_instructor']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_public_cursos_por_instructor']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_public_cursos_por_instructor']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_public_cursos_por_instructor']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_public_cursos_por_instructor']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {

...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["PROYECTO_SENA_____grid_public_instructor"]))
   {
      unset($_SESSION['session_sec_aplicacao']["PROYECTO_SENA_____grid_public_instructor"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_public_instructor'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_public_instructor']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_public_instructor']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_public_instructor']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_public_instructor']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_public_instructor']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_public_instructor</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_public_instructor']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_public_instructor']['embutida_filho'] as $ind => $sc_init)
          {

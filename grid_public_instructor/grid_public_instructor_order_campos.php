<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_public_instructor']['glo_nm_path_imag_temp'] . "/sc_apl_default_PROYECTO_SENA.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_public_instructor_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_public_instructor_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_public_instructor']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_public_instructor']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels     = array();
   $tab_ger_campos['i_nombre'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['i_nombre'] = "i_nombre";
   }
   else
   {
       $tab_def_campos['i_nombre'] = "i.nombre";
   }
   $tab_labels["i_nombre"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_public_instructor']['labels']["i_nombre"])) ? $_SESSION['sc_session'][$sc_init]['grid_public_instructor']['labels']["i_nombre"] : "Nombre";
   $tab_ger_campos['i_apellido'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['i_apellido'] = "i_apellido";
   }
   else
   {
       $tab_def_campos['i_apellido'] = "i.apellido";
   }
   $tab_labels["i_apellido"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_public_instructor']['labels']["i_apellido"])) ? $_SESSION['sc_session'][$sc_init]['grid_public_instructor']['labels']["i_apellido"] : "Apellido";
   $tab_ger_campos['i_numero_documento'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['i_numero_documento'] = "i_numero_documento";
   }
   else
   {
       $tab_def_campos['i_numero_documento'] = "i.numero_documento";
   }
   $tab_labels["i_numero_documento"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_public_instructor']['labels']["i_numero_documento"])) ? $_SESSION['sc_session'][$sc_init]['grid_public_instructor']['labels']["i_numero_documento"] : "Numero Documento";
   $tab_ger_campos['especialidad'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['especialidad'] = "especialidad";
   }
   else
   {
       $tab_def_campos['especialidad'] = "e.descripcion";
   }
   $tab_labels["especialidad"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_public_instructor']['labels']["especialidad"])) ? $_SESSION['sc_session'][$sc_init]['grid_public_instructor']['labels']["especialidad"] : "Especialidad";
   $tab_ger_campos['i_titulo_academico'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['i_titulo_academico'] = "i_titulo_academico";
   }
   else
   {
       $tab_def_campos['i_titulo_academico'] = "i.titulo_academico";
   }
   $tab_labels["i_titulo_academico"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_public_instructor']['labels']["i_titulo_academico"])) ? $_SESSION['sc_session'][$sc_init]['grid_public_instructor']['labels']["i_titulo_academico"] : "Titulo Académico";
   ...
   {
       $tab_def_campos['sc_field_0'] = "i.experiencia_años";
   }
   $tab_labels["sc_field_0"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_public_instructor']['labels']["sc_field_0"])) ? $_SESSION['sc_session'][$sc_init]['grid_public_instructor']['labels']["sc_field_0"] : "experiencia_años";
   $tab_ger_campos['i_email'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['i_email'] = "i_email";
   }
   else
   {
       $tab_def_campos['i_email'] = "i.email";
   }
   $tab_labels["i_email"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_public_instructor']['labels']["i_email"])) ? $_SESSION['sc_session'][$sc_init]['grid_public_instructor']['labels']["i_email"] : "Email";
   ...
   {
       $tab_def_campos['estado'] = "CASE 
        WHEN i.activo = TRUE THEN 'Activo'
        ELSE 'Inactivo'
    END";
   }
   $tab_labels["estado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_public_instructor']['labels']["estado"])) ? $_SESSION['sc_session'][$sc_init]['grid_public_instructor']['labels']["estado"] : "Estado";
   $tab_ger_campos['i_fecha_contratacion'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['i_fecha_contratacion'] = "i_fecha_contratacion";
   }
   else
   {
       $tab_def_campos['i_fecha_contratacion'] = "i.fecha_contratacion";
   }
   $tab_labels["i_fecha_contratacion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_public_instructor']['labels']["i_fecha_contratacion"])) ? $_SESSION['sc_session'][$sc_init]['grid_public_instructor']['labels']["i_fecha_contratacion"] : "Fecha Contratación";
   $tab_ger_campos['tipo_contrato'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['tipo_contrato'] = "tipo_contrato";
   }
   else
   {
       $tab_def_campos['tipo_contrato'] = "tc.descripcion";
   }
   $tab_labels["tipo_contrato"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_public_instructor']['labels']["tipo_contrato"])) ? $_SESSION['sc_session'][$sc_init]['grid_public_instructor']['labels']["tipo_contrato"] : "Tipo Contrato";
   $tab_ger_campos['i_telefono'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['i_telefono'] = "i_telefono";
   }
   else
   {
       $tab_def_campos['i_telefono'] = "i.telefono";
   }
   $tab_labels["i_telefono"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_public_instructor']['labels']["i_telefono"])) ? $_SESSION['sc_session'][$sc_init]['grid_public_instructor']['labels']["i_telefono"] : "Teléfono";
   $tab_ger_campos['i_created_at'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['i_created_at'] = "i_created_at";
   }
   else
   {
       $tab_def_campos['i_created_at'] = "i.created_at";
   }
   $tab_labels["i_created_at"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_public_instructor']['labels']["i_created_at"])) ? $_SESSION['sc_session'][$sc_init]['grid_public_instructor']['labels']["i_created_at"] : "Fecha de creación";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_public_instructor']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_public_instructor']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_public_instructor']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_public_instructor']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_public_instructor']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_public_instructor']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_public_instructor']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_public_instructor']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_public_instructor']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_public_instructor']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_public_instructor']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_public_instructor']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_public_instructor_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_public_instructor']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_public_instructor']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_public_instructor']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_public_instructor']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_public_instructor']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {

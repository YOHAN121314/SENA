...
function scEventControl_init(iSeqRow) {
  ...
  scEventControl_data["salir" + iSeqRow] = {"blur": false, "change": false, "autocomp": false, "original": "", "calculated": ""};
}
...
function scEventControl_active(iSeqRow) {
  ...
  if (scEventControl_data["salir" + iSeqRow] && scEventControl_data["salir" + iSeqRow]["blur"]) {
    return true;
  }
  if (scEventControl_data["salir" + iSeqRow] && scEventControl_data["salir" + iSeqRow]["change"]) {
    return true;
  }
  return false;
...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_salir' + iSeqRow).bind('blur', function() { sc_app_Login_salir_onblur(this, iSeqRow) })
                                   .bind('change', function() { sc_app_Login_salir_onchange(this, iSeqRow) })
                                   .bind('focus', function() { sc_app_Login_salir_onfocus(this, iSeqRow) });
...
function sc_app_Login_salir_onblur(oThis, iSeqRow) {
  do_ajax_app_Login_validate_salir();
  scCssBlur(oThis);
}

function sc_app_Login_salir_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_app_Login_salir_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function displayChange_block_1(status) {
	...
	displayChange_field("salir", "", status);
}
...
function displayChange_row(row, status) {
	...
	displayChange_field_salir(row, status);
}
...
function displayChange_field_salir(row, status) {
    var fieldId;
}

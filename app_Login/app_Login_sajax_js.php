...
?>
  ...
  // ---------- Validate salir
  function do_ajax_app_Login_validate_salir()
  {
    var nomeCampo_salir = "salir";
    var var_salir = scAjaxGetFieldText(nomeCampo_salir);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_Login_validate_salir(var_salir, var_script_case_init, do_ajax_app_Login_validate_salir_cb);
  } // do_ajax_app_Login_validate_salir

  function do_ajax_app_Login_validate_salir_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "salir";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_Login_validate_salir_cb
...
function scJs_sweetalert_params(params) {
  ...
  function do_ajax_app_Login_submit_form()
  {
    ...
    var var_salir = scAjaxGetFieldText("salir");
    ...
    x_ajax_app_Login_submit_form(var_login, var_pswd, var_remember_me, var_new_user, var_retrieve_pswd, var_salir, var_new_user_sc_target_name, var_retrieve_pswd_sc_target_name, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, var_bok, do_ajax_app_Login_submit_form_cb);
...
?>
  ...
  var ajax_error_list = {
    ...
    "pswd": {"label": "<?php echo $this->Ini->Nm_lang['lang_sec_pasword_fild_login'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "salir": {"label": "Salir", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_id = {
    ...
    "salir": new Array("hidden_field_label_salir", "hidden_field_data_salir")
  };

...
//
   function init()
   {
      ...
      $this->nm_dt_criacao   = "20250909"; 
      $this->nm_hr_criacao   = "114443"; 
...
// 
      ...
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
...
// 
  function conectDB()
  {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['app_Login']['glo_nm_conexao'], $this->root . $this->path_prod, 'PROYECTO_SENA', 1, $this->force_db_utf8); 
      } 
      else 
      { 
  ...
  function setConnectionHash() {
    if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['app_Login']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['app_Login']['glo_nm_conexao'])) {
      list($connectionDbms, $connectionHost, $connectionUser, $connectionPassword, $connectionDatabase) = db_conect_devel($_SESSION['scriptcase']['app_Login']['glo_nm_conexao'], $this->root . $this->path_prod, 'PROYECTO_SENA', 1, $this->force_db_utf8);
    }
    else {
...
$this->sc_temp_sett_session_expire = 'R';
$this->sc_temp_sett_remember_me = 'N';
$this->sc_temp_sett_cookie_expiration_time = '';
$this->sc_temp_sett_retrieve_password = 'Y';
$this->sc_temp_sett_new_users = 'Y';
$this->sc_temp_sett_brute_force = 'Y';
$this->sc_temp_sett_brute_force_time_block = '10';
$this->sc_temp_sett_brute_force_attempts = '10';
$this->sc_temp_sett_enable_2fa = 'N';
$this->sc_temp_sett_enable_2fa_expiration_time = '300';
return;
...
if($this->remember_me  == 1){
    ...
    $slogin = $this->Db->qstr($this->login );
     ...
     $nm_select ="UPDATE public.sec_users SET activation_code = ". $this->Db->qstr($code) . " WHERE login = ". $slogin; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
...
;
        ...
        if($this->sc_temp_sett_session_expire != 'N'){
            if (is_file($_SESSION['scriptcase']['dir_temp'] . "/sc_apl_default_PROYECTO_SENA.txt")) {
    unlink($_SESSION['scriptcase']['dir_temp'] . "/sc_apl_default_PROYECTO_SENA.txt");
}
if (is_file("../_lib/friendly_url/app_Login_ini.txt")) {
    $SC_arq_def = fopen($_SESSION['scriptcase']['dir_temp'] . "/sc_apl_default_PROYECTO_SENA.txt", "w");
    fwrite ($SC_arq_def, 'app_Login, $this->sc_temp_sett_session_expire');
    fclose ($SC_arq_def);
    setcookie('sc_apl_default_PROYECTO_SENA','app_Login, $this->sc_temp_sett_session_expire','0','/');
}
;
        }
     if (isset($this->sc_temp_usr_login)) { $_SESSION['usr_login'] = $this->sc_temp_usr_login;}
...
//
    ...
    if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
        ...
        elseif (is_file($root . $_SESSION['scriptcase']['app_Login']['glo_nm_path_imag_temp'] . "/sc_apl_default_PROYECTO_SENA.txt")) {
            $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['app_Login']['glo_nm_path_imag_temp'] . "/sc_apl_default_PROYECTO_SENA.txt"));
        }
        if (isset($apl_def)) {
            ...
            if (isset($_COOKIE['sc_actual_lang_PROYECTO_SENA'])) {
                $_SESSION['scriptcase']['app_Login']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_PROYECTO_SENA'];
            }
        }
    }
    ...
    if (isset($_POST['rs']) && !is_array($_POST['rs']) && 'ajax_' == substr($_POST['rs'], 0, 5) && isset($_POST['rsargs']) && !empty($_POST['rsargs']) && !isset($_SESSION['scriptcase']['app_Login']['session_timeout']['redir']))
    {
        ...
        if ('ajax_app_Login_validate_salir' == $_POST['rs'])
        {
            $salir = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_app_Login_submit_form' == $_POST['rs'])
        {
            ...
            $salir = NM_utf8_urldecode($_POST['rsargs'][5]);
            $new_user_sc_target_name = NM_utf8_urldecode($_POST['rsargs'][6]);
            $retrieve_pswd_sc_target_name = NM_utf8_urldecode($_POST['rsargs'][7]);
    ...
    sajax_export("ajax_app_Login_validate_salir");
...
//
    ...
    function ajax_app_Login_validate_salir($salir, $script_case_init)
    {
        global $inicial_app_Login;
        //register_shutdown_function("app_Login_pack_ajax_response");
        $inicial_app_Login->contr_app_Login->NM_ajax_flag          = true;
        $inicial_app_Login->contr_app_Login->NM_ajax_opcao         = 'validate_salir';
        $inicial_app_Login->contr_app_Login->NM_ajax_info['param'] = array(
                  'salir' => NM_utf8_urldecode($salir),
                  'script_case_init' => NM_utf8_urldecode($script_case_init),
                  'buffer_output' => true,
                 );
        if ($inicial_app_Login->contr_app_Login->NM_ajax_info['param']['buffer_output'])
    ...
    function ajax_app_Login_submit_form($login, $pswd, $remember_me, $new_user, $retrieve_pswd, $salir, $new_user_sc_target_name, $retrieve_pswd_sc_target_name, $nm_form_submit, $nmgp_url_saida, $nmgp_opcao, $nmgp_ancora, $nmgp_num_form, $nmgp_parms, $script_case_init, $csrf_token, $bok)
    {
        global $inicial_app_Login;
        //register_shutdown_function("app_Login_pack_ajax_response");
        $inicial_app_Login->contr_app_Login->NM_ajax_flag          = true;

  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_public_cursos_por_instructor_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_public_cursos_por_instructor_mob_form();
	}
...
?>
  ...
  // ---------- Validate id_curso
  function do_ajax_form_public_cursos_por_instructor_mob_validate_id_curso()
  {
    var nomeCampo_id_curso = "id_curso";
    var var_id_curso = scAjaxGetFieldSelect(nomeCampo_id_curso);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_public_cursos_por_instructor_mob_validate_id_curso(var_id_curso, var_script_case_init, do_ajax_form_public_cursos_por_instructor_mob_validate_id_curso_cb);
  } // do_ajax_form_public_cursos_por_instructor_mob_validate_id_curso

  function do_ajax_form_public_cursos_por_instructor_mob_validate_id_curso_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_public_cursos_por_instructor_mob_validate_id_curso_cb

  // ---------- Validate id_instructor
  function do_ajax_form_public_cursos_por_instructor_mob_validate_id_instructor()
  {
    var nomeCampo_id_instructor = "id_instructor";
    var var_id_instructor = scAjaxGetFieldSelect(nomeCampo_id_instructor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_public_cursos_por_instructor_mob_validate_id_instructor(var_id_instructor, var_script_case_init, do_ajax_form_public_cursos_por_instructor_mob_validate_id_instructor_cb);
  } // do_ajax_form_public_cursos_por_instructor_mob_validate_id_instructor

  function do_ajax_form_public_cursos_por_instructor_mob_validate_id_instructor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id_instructor";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_public_cursos_por_instructor_mob_validate_id_instructor_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_public_cursos_por_instructor_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_public_cursos_por_instructor_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id_curso = scAjaxGetFieldSelect("id_curso");
    var var_id_instructor = scAjaxGetFieldSelect("id_instructor");
    ...
    scAjaxProcOn();
    x_ajax_form_public_cursos_por_instructor_mob_submit_form(var_id_curso, var_id_instructor, var_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_public_cursos_por_instructor_mob_submit_form_cb);
  } // do_ajax_form_public_cursos_por_instructor_mob_submit_form

  function do_ajax_form_public_cursos_por_instructor_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("id_instructor");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_public_cursos_por_instructor_mob_submit_form_cb_after_alert);
  } // do_ajax_form_public_cursos_por_instructor_mob_submit_form_cb
  function do_ajax_form_public_cursos_por_instructor_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_public_cursos_por_instructor_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_public_cursos_por_instructor_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_public_cursos_por_instructor_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_public_cursos_por_instructor_mob_navigate_form();
    }
  }

  function perform_ajax_form_public_cursos_por_instructor_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_public_cursos_por_instructor_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_public_cursos_por_instructor_mob_navigate_form_cb);
  } // do_ajax_form_public_cursos_por_instructor_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_cursos_por_instructor_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_public_cursos_por_instructor_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_public_cursos_por_instructor_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_public_cursos_por_instructor_mob_navigate_form_cb
  function do_ajax_form_public_cursos_por_instructor_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_public_cursos_por_instructor_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_public_cursos_por_instructor_mob_navigate_form_cb_after_alert

  function sc_hide_form_public_cursos_por_instructor_mob_form()
  {
  ...
  ajax_field_list[0] = "id_curso";
  ajax_field_list[1] = "id_instructor";
  ...
  var ajax_error_list = {
    ...
    "id_instructor": {"label": "Instructor", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0}
  };
  ...
  var ajax_field_mult = {
    "id_curso": new Array(),
    "id_instructor": new Array()
  };
  ajax_field_mult["id_curso"][1] = "id_curso";
  ajax_field_mult["id_instructor"][1] = "id_instructor";

  var ajax_field_id = {
    "id_curso": new Array("hidden_field_label_id_curso", "hidden_field_data_id_curso"),
    "id_instructor": new Array("hidden_field_label_id_instructor", "hidden_field_data_id_instructor")
  };

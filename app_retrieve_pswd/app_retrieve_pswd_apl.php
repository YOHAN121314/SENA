...
$sql = "SELECT email FROM public.sec_users WHERE login = '".$param_login."'";
...
$pswd = $this->act_code();
$sql  = "UPDATE public.sec_users SET pswd = '". hash("sha256",$pswd) ."' WHERE login = '". $this->sc_temp_usr_login ."'";

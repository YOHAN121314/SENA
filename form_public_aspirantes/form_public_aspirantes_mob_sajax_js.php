  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_public_aspirantes_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_public_aspirantes_mob_form();
	}
...
?>
  ...
  // ---------- Validate nombre
  function do_ajax_form_public_aspirantes_mob_validate_nombre()
  {
    var nomeCampo_nombre = "nombre";
    var var_nombre = scAjaxGetFieldText(nomeCampo_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_public_aspirantes_mob_validate_nombre(var_nombre, var_script_case_init, do_ajax_form_public_aspirantes_mob_validate_nombre_cb);
  } // do_ajax_form_public_aspirantes_mob_validate_nombre

  function do_ajax_form_public_aspirantes_mob_validate_nombre_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_public_aspirantes_mob_validate_nombre_cb

  // ---------- Validate apellido
  function do_ajax_form_public_aspirantes_mob_validate_apellido()
  {
    var nomeCampo_apellido = "apellido";
    var var_apellido = scAjaxGetFieldText(nomeCampo_apellido);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_public_aspirantes_mob_validate_apellido(var_apellido, var_script_case_init, do_ajax_form_public_aspirantes_mob_validate_apellido_cb);
  } // do_ajax_form_public_aspirantes_mob_validate_apellido

  function do_ajax_form_public_aspirantes_mob_validate_apellido_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_public_aspirantes_mob_validate_apellido_cb

  // ---------- Validate documento_identidad
  function do_ajax_form_public_aspirantes_mob_validate_documento_identidad()
  {
    var nomeCampo_documento_identidad = "documento_identidad";
    var var_documento_identidad = scAjaxGetFieldText(nomeCampo_documento_identidad);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_public_aspirantes_mob_validate_documento_identidad(var_documento_identidad, var_script_case_init, do_ajax_form_public_aspirantes_mob_validate_documento_identidad_cb);
  } // do_ajax_form_public_aspirantes_mob_validate_documento_identidad

  function do_ajax_form_public_aspirantes_mob_validate_documento_identidad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "documento_identidad";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_public_aspirantes_mob_validate_documento_identidad_cb

  // ---------- Validate email
  function do_ajax_form_public_aspirantes_mob_validate_email()
  {
    var nomeCampo_email = "email";
    var var_email = scAjaxGetFieldText(nomeCampo_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_public_aspirantes_mob_validate_email(var_email, var_script_case_init, do_ajax_form_public_aspirantes_mob_validate_email_cb);
  } // do_ajax_form_public_aspirantes_mob_validate_email

  function do_ajax_form_public_aspirantes_mob_validate_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "email";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_public_aspirantes_mob_validate_email_cb

  // ---------- Validate fecha_nacimiento
  function do_ajax_form_public_aspirantes_mob_validate_fecha_nacimiento()
  {
    ...
    setTimeout(function() {
      var var_fecha_nacimiento = scAjaxGetFieldText(nomeCampo_fecha_nacimiento);
      x_ajax_form_public_aspirantes_mob_validate_fecha_nacimiento(var_fecha_nacimiento, var_script_case_init, do_ajax_form_public_aspirantes_mob_validate_fecha_nacimiento_cb);
    }, 200);
  } // do_ajax_form_public_aspirantes_mob_validate_fecha_nacimiento

  function do_ajax_form_public_aspirantes_mob_validate_fecha_nacimiento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_public_aspirantes_mob_validate_fecha_nacimiento_cb

  // ---------- Validate direccion
  function do_ajax_form_public_aspirantes_mob_validate_direccion()
  {
    var nomeCampo_direccion = "direccion";
    var var_direccion = scAjaxGetFieldText(nomeCampo_direccion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_public_aspirantes_mob_validate_direccion(var_direccion, var_script_case_init, do_ajax_form_public_aspirantes_mob_validate_direccion_cb);
  } // do_ajax_form_public_aspirantes_mob_validate_direccion

  function do_ajax_form_public_aspirantes_mob_validate_direccion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_public_aspirantes_mob_validate_direccion_cb

  // ---------- Validate telefono
  function do_ajax_form_public_aspirantes_mob_validate_telefono()
  {
    var nomeCampo_telefono = "telefono";
    var var_telefono = scAjaxGetFieldText(nomeCampo_telefono);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_public_aspirantes_mob_validate_telefono(var_telefono, var_script_case_init, do_ajax_form_public_aspirantes_mob_validate_telefono_cb);
  } // do_ajax_form_public_aspirantes_mob_validate_telefono

  function do_ajax_form_public_aspirantes_mob_validate_telefono_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_public_aspirantes_mob_validate_telefono_cb

  // ---------- Validate activo
  function do_ajax_form_public_aspirantes_mob_validate_activo()
  {
    var nomeCampo_activo = "activo";
    var var_activo = scAjaxGetFieldSelect(nomeCampo_activo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_public_aspirantes_mob_validate_activo(var_activo, var_script_case_init, do_ajax_form_public_aspirantes_mob_validate_activo_cb);
  } // do_ajax_form_public_aspirantes_mob_validate_activo

  function do_ajax_form_public_aspirantes_mob_validate_activo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "activo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_public_aspirantes_mob_validate_activo_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_public_aspirantes_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_public_aspirantes_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_nombre = scAjaxGetFieldText("nombre");
    var var_apellido = scAjaxGetFieldText("apellido");
    var var_documento_identidad = scAjaxGetFieldText("documento_identidad");
    ...
    scAjaxProcOn();
    x_ajax_form_public_aspirantes_mob_submit_form(var_nombre, var_apellido, var_documento_identidad, var_email, var_fecha_nacimiento, var_direccion, var_telefono, var_activo, var_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_public_aspirantes_mob_submit_form_cb);
  } // do_ajax_form_public_aspirantes_mob_submit_form

  function do_ajax_form_public_aspirantes_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("documento_identidad");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_public_aspirantes_mob_submit_form_cb_after_alert);
  } // do_ajax_form_public_aspirantes_mob_submit_form_cb
  function do_ajax_form_public_aspirantes_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_public_aspirantes_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_public_aspirantes_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_public_aspirantes_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_public_aspirantes_mob_navigate_form();
    }
  }

  function perform_ajax_form_public_aspirantes_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_public_aspirantes_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_public_aspirantes_mob_navigate_form_cb);
  } // do_ajax_form_public_aspirantes_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_aspirantes_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_public_aspirantes_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_public_aspirantes_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_public_aspirantes_mob_navigate_form_cb
  function do_ajax_form_public_aspirantes_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_public_aspirantes_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_public_aspirantes_mob_navigate_form_cb_after_alert

  function sc_hide_form_public_aspirantes_mob_form()
  {
  ...
  ajax_field_list[2] = "documento_identidad";
  ajax_field_list[3] = "email";
  ajax_field_list[4] = "fecha_nacimiento";
  ...
  var ajax_error_list = {
    ...
    "documento_identidad": {"label": "Numero_Documento ", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
  ...
  ajax_field_mult["documento_identidad"][1] = "documento_identidad";
  ...
  var ajax_field_id = {
    ...
    "documento_identidad": new Array("hidden_field_label_documento_identidad", "hidden_field_data_documento_identidad"),

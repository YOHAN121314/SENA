...
function scEventControl_init(iSeqRow) {
  ...
  scEventControl_data["recordar_pswd" + iSeqRow] = {"blur": false, "change": false, "autocomp": false, "original": "", "calculated": ""};
...
function scEventControl_active(iSeqRow) {
  ...
  if (scEventControl_data["recordar_pswd" + iSeqRow] && scEventControl_data["recordar_pswd" + iSeqRow]["blur"]) {
    return true;
  }
  if (scEventControl_data["recordar_pswd" + iSeqRow] && scEventControl_data["recordar_pswd" + iSeqRow]["change"]) {
    return true;
  }
...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_recordar_pswd' + iSeqRow).bind('blur', function() { sc_login_recordar_pswd_onblur(this, iSeqRow) })
                                           .bind('change', function() { sc_login_recordar_pswd_onchange(this, iSeqRow) })
                                           .bind('focus', function() { sc_login_recordar_pswd_onfocus(this, iSeqRow) });
...
function sc_login_recordar_pswd_onblur(oThis, iSeqRow) {
  do_ajax_login_validate_recordar_pswd();
  scCssBlur(oThis);
}

function sc_login_recordar_pswd_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_login_recordar_pswd_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function displayChange_block_0(status) {
	...
	displayChange_field("recordar_pswd", "", status);
...
function displayChange_row(row, status) {
	...
	displayChange_field_recordar_pswd(row, status);
...
function displayChange_field_recordar_pswd(row, status) {
    var fieldId;
}

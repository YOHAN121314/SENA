...
?>
  ...
  function do_ajax_login_validate_remember_me()
  {
    ...
    var var_remember_me = scAjaxGetFieldText(nomeCampo_remember_me);
    var var_script_case_init = document.F1.script_case_init.value;
  ...
  // ---------- Validate recordar_pswd
  function do_ajax_login_validate_recordar_pswd()
  {
    var nomeCampo_recordar_pswd = "recordar_pswd";
    var var_recordar_pswd = scAjaxGetFieldText(nomeCampo_recordar_pswd);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_login_validate_recordar_pswd(var_recordar_pswd, var_script_case_init, do_ajax_login_validate_recordar_pswd_cb);
  } // do_ajax_login_validate_recordar_pswd

  function do_ajax_login_validate_recordar_pswd_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "recordar_pswd";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_login_validate_recordar_pswd_cb
...
function scJs_sweetalert_params(params) {
  ...
  function do_ajax_login_submit_form()
  {
    ...
    var var_remember_me = scAjaxGetFieldText("remember_me");
    var var_recordar_pswd = scAjaxGetFieldText("recordar_pswd");
    var var_new_user = scAjaxGetFieldText("new_user");
    var var_remember_me_sc_target_name = document.F1.remember_me_sc_target_name.value;
    var var_recordar_pswd_sc_target_name = document.F1.recordar_pswd_sc_target_name.value;
    ...
    x_ajax_login_submit_form(var_login, var_pswd, var_remember_me, var_recordar_pswd, var_new_user, var_remember_me_sc_target_name, var_recordar_pswd_sc_target_name, var_new_user_sc_target_name, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, var_bok, do_ajax_login_submit_form_cb);
...
?>
  ...
  ajax_field_list[3] = "recordar_pswd";
  ...
  var ajax_error_list = {
    "login": {"label": "usuario", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    ...
    "remember_me": {"label": "new_user", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "recordar_pswd": {"label": "retrieve_pswd", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "new_user": {"label": "new_user", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0}
  };

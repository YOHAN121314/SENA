...
<HEAD>
 <TITLE><?php if ('novo' == $this->nmgp_opcao) { echo strip_tags("" . $this->Ini->Nm_lang['lang_othr_frmi_titl'] . ""); } else { echo strip_tags(""); } ?></TITLE>
...
<?php
   if (!isset($this->nmgp_cmp_hidden['remember_me']))
   {
       $this->nmgp_cmp_hidden['remember_me'] = 'off';
   }
   if (!isset($this->nmgp_cmp_hidden['recordar_pswd']))
   {
       $this->nmgp_cmp_hidden['recordar_pswd'] = 'off';
   }
   if (!isset($this->nmgp_cmp_hidden['new_user']))
   {
       $this->nmgp_cmp_hidden['new_user'] = 'off';
   }
?>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   {
       $this->nm_new_label['remember_me'] = "new_user";
   }
   $nm_cor_fun_cel  = (isset($nm_cor_fun_cel) && $nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
   $nm_img_fun_cel  = (isset($nm_img_fun_cel) && $nm_img_fun_cel  == $this->Ini->img_fun_imp    ? $this->Ini->img_fun_par  : $this->Ini->img_fun_imp);

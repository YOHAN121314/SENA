...
//
   ...
   $_SESSION['scriptcase']['login']['glo_nm_perfil']          = "conn_postgres";
...
//
   function init()
   {
      ...
      $this->nm_dt_criacao   = "20250908"; 
      $this->nm_hr_criacao   = "131855"; 
...
// 
      ...
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
...
// 
  function conectDB()
  {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['login']['glo_nm_conexao'], $this->root . $this->path_prod, 'PROYECTO_SENA', 1, $this->force_db_utf8); 
      } 
      else 
      { 
  ...
  function setConnectionHash() {
    if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['login']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['login']['glo_nm_conexao'])) {
      list($connectionDbms, $connectionHost, $connectionUser, $connectionPassword, $connectionDatabase) = db_conect_devel($_SESSION['scriptcase']['login']['glo_nm_conexao'], $this->root . $this->path_prod, 'PROYECTO_SENA', 1, $this->force_db_utf8);
    }
    else {
...
//
    ...
    if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
        ...
        elseif (is_file($root . $_SESSION['scriptcase']['login']['glo_nm_path_imag_temp'] . "/sc_apl_default_PROYECTO_SENA.txt")) {
            $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['login']['glo_nm_path_imag_temp'] . "/sc_apl_default_PROYECTO_SENA.txt"));
        }
        if (isset($apl_def)) {
            if ($apl_def[0] != "login") {
            ...
            if (isset($_COOKIE['sc_actual_lang_PROYECTO_SENA'])) {
                $_SESSION['scriptcase']['login']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_PROYECTO_SENA'];
            }
        }
    }
    ...
    if (isset($_POST['rs']) && !is_array($_POST['rs']) && 'ajax_' == substr($_POST['rs'], 0, 5) && isset($_POST['rsargs']) && !empty($_POST['rsargs']) && !isset($_SESSION['scriptcase']['login']['session_timeout']['redir']))
    {
        ...
        if ('ajax_login_validate_recordar_pswd' == $_POST['rs'])
        {
            $recordar_pswd = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        ...
        if ('ajax_login_submit_form' == $_POST['rs'])
        {
            ...
            $recordar_pswd = NM_utf8_urldecode($_POST['rsargs'][3]);
            $new_user = NM_utf8_urldecode($_POST['rsargs'][4]);
            $remember_me_sc_target_name = NM_utf8_urldecode($_POST['rsargs'][5]);
            $recordar_pswd_sc_target_name = NM_utf8_urldecode($_POST['rsargs'][6]);
    ...
    else
    {
        ...
        if (isset($_POST["sett_session_expire"])) 
        {
            ...
            nm_limpa_str_login($_SESSION['sett_session_expire']);
        }
    ...
    sajax_export("ajax_login_validate_recordar_pswd");
...
//
    ...
    function ajax_login_validate_recordar_pswd($recordar_pswd, $script_case_init)
    {
        global $inicial_login;
        //register_shutdown_function("login_pack_ajax_response");
        $inicial_login->contr_login->NM_ajax_flag          = true;
        $inicial_login->contr_login->NM_ajax_opcao         = 'validate_recordar_pswd';
        $inicial_login->contr_login->NM_ajax_info['param'] = array(
                  'recordar_pswd' => NM_utf8_urldecode($recordar_pswd),
                  'script_case_init' => NM_utf8_urldecode($script_case_init),
                  'buffer_output' => true,
                 );
        if ($inicial_login->contr_login->NM_ajax_info['param']['buffer_output'])
    ...
    function ajax_login_submit_form($login, $pswd, $remember_me, $recordar_pswd, $new_user, $remember_me_sc_target_name, $recordar_pswd_sc_target_name, $new_user_sc_target_name, $nm_form_submit, $nmgp_url_saida, $nmgp_opcao, $nmgp_ancora, $nmgp_num_form, $nmgp_parms, $script_case_init, $csrf_token, $bok)
    {
        global $inicial_login;
        //register_shutdown_function("login_pack_ajax_response");
        $inicial_login->contr_login->NM_ajax_flag          = true;
        ...
        $inicial_login->contr_login->NM_ajax_info['param'] = array(
                  ...
                  'recordar_pswd' => NM_utf8_urldecode($recordar_pswd),
                  'new_user' => NM_utf8_urldecode($new_user),
                  'remember_me_sc_target_name' => NM_utf8_urldecode($remember_me_sc_target_name),
                  'recordar_pswd_sc_target_name' => NM_utf8_urldecode($recordar_pswd_sc_target_name),

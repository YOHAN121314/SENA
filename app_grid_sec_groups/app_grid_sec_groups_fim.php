...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["PROYECTO_SENA_____app_grid_sec_groups"]))
   {
      unset($_SESSION['session_sec_aplicacao']["PROYECTO_SENA_____app_grid_sec_groups"]);
   }

  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_public_cursos" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_public_cursos_form();
	}
...
?>
  ...
  // ---------- Validate id_area
  function do_ajax_form_public_cursos_validate_id_area()
  {
    var nomeCampo_id_area = "id_area";
    var var_id_area = scAjaxGetFieldSelect(nomeCampo_id_area);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_public_cursos_validate_id_area(var_id_area, var_script_case_init, do_ajax_form_public_cursos_validate_id_area_cb);
  } // do_ajax_form_public_cursos_validate_id_area

  function do_ajax_form_public_cursos_validate_id_area_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_public_cursos_validate_id_area_cb

  // ---------- Validate nombre_curso
  function do_ajax_form_public_cursos_validate_nombre_curso()
  {
    var nomeCampo_nombre_curso = "nombre_curso";
    var var_nombre_curso = scAjaxGetFieldText(nomeCampo_nombre_curso);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_public_cursos_validate_nombre_curso(var_nombre_curso, var_script_case_init, do_ajax_form_public_cursos_validate_nombre_curso_cb);
  } // do_ajax_form_public_cursos_validate_nombre_curso

  function do_ajax_form_public_cursos_validate_nombre_curso_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_public_cursos_validate_nombre_curso_cb

  // ---------- Validate descripcion
  function do_ajax_form_public_cursos_validate_descripcion()
  {
    var nomeCampo_descripcion = "descripcion";
    var var_descripcion = scAjaxGetFieldText(nomeCampo_descripcion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_public_cursos_validate_descripcion(var_descripcion, var_script_case_init, do_ajax_form_public_cursos_validate_descripcion_cb);
  } // do_ajax_form_public_cursos_validate_descripcion

  function do_ajax_form_public_cursos_validate_descripcion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_public_cursos_validate_descripcion_cb

  // ---------- Validate intensidad_horas
  function do_ajax_form_public_cursos_validate_intensidad_horas()
  {
    var nomeCampo_intensidad_horas = "intensidad_horas";
    var var_intensidad_horas = scAjaxGetFieldText(nomeCampo_intensidad_horas);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_public_cursos_validate_intensidad_horas(var_intensidad_horas, var_script_case_init, do_ajax_form_public_cursos_validate_intensidad_horas_cb);
  } // do_ajax_form_public_cursos_validate_intensidad_horas

  function do_ajax_form_public_cursos_validate_intensidad_horas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_public_cursos_validate_intensidad_horas_cb

  // ---------- Validate sc_field_0
  function do_ajax_form_public_cursos_validate_sc_field_0()
  {
    var nomeCampo_sc_field_0 = "sc_field_0";
    var var_sc_field_0 = scAjaxGetFieldText(nomeCampo_sc_field_0);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_public_cursos_validate_sc_field_0(var_sc_field_0, var_script_case_init, do_ajax_form_public_cursos_validate_sc_field_0_cb);
  } // do_ajax_form_public_cursos_validate_sc_field_0

  function do_ajax_form_public_cursos_validate_sc_field_0_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_public_cursos_validate_sc_field_0_cb

  // ---------- Validate id_nivel
  function do_ajax_form_public_cursos_validate_id_nivel()
  {
    var nomeCampo_id_nivel = "id_nivel";
    var var_id_nivel = scAjaxGetFieldSelect(nomeCampo_id_nivel);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_public_cursos_validate_id_nivel(var_id_nivel, var_script_case_init, do_ajax_form_public_cursos_validate_id_nivel_cb);
  } // do_ajax_form_public_cursos_validate_id_nivel

  function do_ajax_form_public_cursos_validate_id_nivel_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_public_cursos_validate_id_nivel_cb

  // ---------- Validate activo
  function do_ajax_form_public_cursos_validate_activo()
  {
    var nomeCampo_activo = "activo";
    var var_activo = scAjaxGetFieldSelect(nomeCampo_activo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_public_cursos_validate_activo(var_activo, var_script_case_init, do_ajax_form_public_cursos_validate_activo_cb);
  } // do_ajax_form_public_cursos_validate_activo

  function do_ajax_form_public_cursos_validate_activo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "activo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_public_cursos_validate_activo_cb

  // ---------- Validate cupo_maximo
  function do_ajax_form_public_cursos_validate_cupo_maximo()
  {
    var nomeCampo_cupo_maximo = "cupo_maximo";
    var var_cupo_maximo = scAjaxGetFieldText(nomeCampo_cupo_maximo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_public_cursos_validate_cupo_maximo(var_cupo_maximo, var_script_case_init, do_ajax_form_public_cursos_validate_cupo_maximo_cb);
  } // do_ajax_form_public_cursos_validate_cupo_maximo

  function do_ajax_form_public_cursos_validate_cupo_maximo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_public_cursos_validate_cupo_maximo_cb

  // ---------- Validate id_modalidad
  function do_ajax_form_public_cursos_validate_id_modalidad()
  {
    var nomeCampo_id_modalidad = "id_modalidad";
    var var_id_modalidad = scAjaxGetFieldSelect(nomeCampo_id_modalidad);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_public_cursos_validate_id_modalidad(var_id_modalidad, var_script_case_init, do_ajax_form_public_cursos_validate_id_modalidad_cb);
  } // do_ajax_form_public_cursos_validate_id_modalidad

  function do_ajax_form_public_cursos_validate_id_modalidad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_public_cursos_validate_id_modalidad_cb

  // ---------- Validate fecha_inicio
  function do_ajax_form_public_cursos_validate_fecha_inicio()
  {
    ...
    setTimeout(function() {
      var var_fecha_inicio = scAjaxGetFieldText(nomeCampo_fecha_inicio);
      x_ajax_form_public_cursos_validate_fecha_inicio(var_fecha_inicio, var_script_case_init, do_ajax_form_public_cursos_validate_fecha_inicio_cb);
    }, 200);
  } // do_ajax_form_public_cursos_validate_fecha_inicio

  function do_ajax_form_public_cursos_validate_fecha_inicio_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_public_cursos_validate_fecha_inicio_cb

  // ---------- Validate fecha_fin
  function do_ajax_form_public_cursos_validate_fecha_fin()
  {
    ...
    setTimeout(function() {
      var var_fecha_fin = scAjaxGetFieldText(nomeCampo_fecha_fin);
      x_ajax_form_public_cursos_validate_fecha_fin(var_fecha_fin, var_script_case_init, do_ajax_form_public_cursos_validate_fecha_fin_cb);
    }, 200);
  } // do_ajax_form_public_cursos_validate_fecha_fin

  function do_ajax_form_public_cursos_validate_fecha_fin_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_public_cursos_validate_fecha_fin_cb

  // ---------- Validate horario
  function do_ajax_form_public_cursos_validate_horario()
  {
    var nomeCampo_horario = "horario";
    var var_horario = scAjaxGetFieldText(nomeCampo_horario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_public_cursos_validate_horario(var_horario, var_script_case_init, do_ajax_form_public_cursos_validate_horario_cb);
  } // do_ajax_form_public_cursos_validate_horario

  function do_ajax_form_public_cursos_validate_horario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "horario";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_public_cursos_validate_horario_cb

  // ---------- Validate created_at
  function do_ajax_form_public_cursos_validate_created_at()
  {
    var nomeCampo_created_at = "created_at";
    var var_created_at = scAjaxGetFieldText(nomeCampo_created_at);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_public_cursos_validate_created_at(var_created_at, var_script_case_init, do_ajax_form_public_cursos_validate_created_at_cb);
  } // do_ajax_form_public_cursos_validate_created_at

  function do_ajax_form_public_cursos_validate_created_at_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_public_cursos_validate_created_at_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_public_cursos_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_public_cursos_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_public_cursos_submit_form(var_id_area, var_nombre_curso, var_descripcion, var_intensidad_horas, var_sc_field_0, var_id_nivel, var_activo, var_cupo_maximo, var_id_modalidad, var_fecha_inicio, var_fecha_fin, var_horario, var_created_at, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_public_cursos_submit_form_cb);
  } // do_ajax_form_public_cursos_submit_form

  function do_ajax_form_public_cursos_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_public_cursos_submit_form_cb_after_alert);
  } // do_ajax_form_public_cursos_submit_form_cb
  function do_ajax_form_public_cursos_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_public_cursos_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_public_cursos_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_public_cursos_navigate_form, function() {});
    } else {
      perform_ajax_form_public_cursos_navigate_form();
    }
  }

  function perform_ajax_form_public_cursos_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_public_cursos_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_public_cursos_navigate_form_cb);
  } // do_ajax_form_public_cursos_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_cursos']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_public_cursos_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_public_cursos_navigate_form_cb_after_alert);
  } // do_ajax_form_public_cursos_navigate_form_cb
  function do_ajax_form_public_cursos_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_public_cursos_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_public_cursos_navigate_form_cb_after_alert

  function sc_hide_form_public_cursos_form()
  {

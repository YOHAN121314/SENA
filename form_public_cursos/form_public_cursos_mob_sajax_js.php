  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_public_cursos_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_public_cursos_mob_form();
	}
...
?>
  ...
  // ---------- Validate id_area
  function do_ajax_form_public_cursos_mob_validate_id_area()
  {
    var nomeCampo_id_area = "id_area";
    var var_id_area = scAjaxGetFieldSelect(nomeCampo_id_area);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_public_cursos_mob_validate_id_area(var_id_area, var_script_case_init, do_ajax_form_public_cursos_mob_validate_id_area_cb);
  } // do_ajax_form_public_cursos_mob_validate_id_area

  function do_ajax_form_public_cursos_mob_validate_id_area_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_public_cursos_mob_validate_id_area_cb

  // ---------- Validate nombre_curso
  function do_ajax_form_public_cursos_mob_validate_nombre_curso()
  {
    var nomeCampo_nombre_curso = "nombre_curso";
    var var_nombre_curso = scAjaxGetFieldText(nomeCampo_nombre_curso);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_public_cursos_mob_validate_nombre_curso(var_nombre_curso, var_script_case_init, do_ajax_form_public_cursos_mob_validate_nombre_curso_cb);
  } // do_ajax_form_public_cursos_mob_validate_nombre_curso

  function do_ajax_form_public_cursos_mob_validate_nombre_curso_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nombre_curso";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_public_cursos_mob_validate_nombre_curso_cb

  // ---------- Validate descripcion
  function do_ajax_form_public_cursos_mob_validate_descripcion()
  {
    var nomeCampo_descripcion = "descripcion";
    var var_descripcion = scAjaxGetFieldText(nomeCampo_descripcion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_public_cursos_mob_validate_descripcion(var_descripcion, var_script_case_init, do_ajax_form_public_cursos_mob_validate_descripcion_cb);
  } // do_ajax_form_public_cursos_mob_validate_descripcion

  function do_ajax_form_public_cursos_mob_validate_descripcion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_public_cursos_mob_validate_descripcion_cb

  // ---------- Validate intensidad_horas
  function do_ajax_form_public_cursos_mob_validate_intensidad_horas()
  {
    var nomeCampo_intensidad_horas = "intensidad_horas";
    var var_intensidad_horas = scAjaxGetFieldText(nomeCampo_intensidad_horas);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_public_cursos_mob_validate_intensidad_horas(var_intensidad_horas, var_script_case_init, do_ajax_form_public_cursos_mob_validate_intensidad_horas_cb);
  } // do_ajax_form_public_cursos_mob_validate_intensidad_horas

  function do_ajax_form_public_cursos_mob_validate_intensidad_horas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "intensidad_horas";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_public_cursos_mob_validate_intensidad_horas_cb

  // ---------- Validate sc_field_0
  function do_ajax_form_public_cursos_mob_validate_sc_field_0()
  {
    var nomeCampo_sc_field_0 = "sc_field_0";
    var var_sc_field_0 = scAjaxGetFieldText(nomeCampo_sc_field_0);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_public_cursos_mob_validate_sc_field_0(var_sc_field_0, var_script_case_init, do_ajax_form_public_cursos_mob_validate_sc_field_0_cb);
  } // do_ajax_form_public_cursos_mob_validate_sc_field_0

  function do_ajax_form_public_cursos_mob_validate_sc_field_0_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_public_cursos_mob_validate_sc_field_0_cb

  // ---------- Validate id_nivel
  function do_ajax_form_public_cursos_mob_validate_id_nivel()
  {
    var nomeCampo_id_nivel = "id_nivel";
    var var_id_nivel = scAjaxGetFieldSelect(nomeCampo_id_nivel);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_public_cursos_mob_validate_id_nivel(var_id_nivel, var_script_case_init, do_ajax_form_public_cursos_mob_validate_id_nivel_cb);
  } // do_ajax_form_public_cursos_mob_validate_id_nivel

  function do_ajax_form_public_cursos_mob_validate_id_nivel_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_public_cursos_mob_validate_id_nivel_cb

  // ---------- Validate activo
  function do_ajax_form_public_cursos_mob_validate_activo()
  {
    var nomeCampo_activo = "activo";
    var var_activo = scAjaxGetFieldSelect(nomeCampo_activo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_public_cursos_mob_validate_activo(var_activo, var_script_case_init, do_ajax_form_public_cursos_mob_validate_activo_cb);
  } // do_ajax_form_public_cursos_mob_validate_activo

  function do_ajax_form_public_cursos_mob_validate_activo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "activo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_public_cursos_mob_validate_activo_cb

  // ---------- Validate cupo_maximo
  function do_ajax_form_public_cursos_mob_validate_cupo_maximo()
  {
    var nomeCampo_cupo_maximo = "cupo_maximo";
    var var_cupo_maximo = scAjaxGetFieldText(nomeCampo_cupo_maximo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_public_cursos_mob_validate_cupo_maximo(var_cupo_maximo, var_script_case_init, do_ajax_form_public_cursos_mob_validate_cupo_maximo_cb);
  } // do_ajax_form_public_cursos_mob_validate_cupo_maximo

  function do_ajax_form_public_cursos_mob_validate_cupo_maximo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cupo_maximo";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_public_cursos_mob_validate_cupo_maximo_cb

  // ---------- Validate id_modalidad
  function do_ajax_form_public_cursos_mob_validate_id_modalidad()
  {
    var nomeCampo_id_modalidad = "id_modalidad";
    var var_id_modalidad = scAjaxGetFieldSelect(nomeCampo_id_modalidad);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_public_cursos_mob_validate_id_modalidad(var_id_modalidad, var_script_case_init, do_ajax_form_public_cursos_mob_validate_id_modalidad_cb);
  } // do_ajax_form_public_cursos_mob_validate_id_modalidad

  function do_ajax_form_public_cursos_mob_validate_id_modalidad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id_modalidad";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_public_cursos_mob_validate_id_modalidad_cb

  // ---------- Validate fecha_inicio
  function do_ajax_form_public_cursos_mob_validate_fecha_inicio()
  {
    ...
    setTimeout(function() {
      var var_fecha_inicio = scAjaxGetFieldText(nomeCampo_fecha_inicio);
      x_ajax_form_public_cursos_mob_validate_fecha_inicio(var_fecha_inicio, var_script_case_init, do_ajax_form_public_cursos_mob_validate_fecha_inicio_cb);
    }, 200);
  } // do_ajax_form_public_cursos_mob_validate_fecha_inicio

  function do_ajax_form_public_cursos_mob_validate_fecha_inicio_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_public_cursos_mob_validate_fecha_inicio_cb

  // ---------- Validate fecha_fin
  function do_ajax_form_public_cursos_mob_validate_fecha_fin()
  {
    var nomeCampo_fecha_fin = "fecha_fin";
    var var_fecha_fin = scAjaxGetFieldText(nomeCampo_fecha_fin);
    var var_script_case_init = document.F1.script_case_init.value;
    setTimeout(function() {
      var var_fecha_fin = scAjaxGetFieldText(nomeCampo_fecha_fin);
      x_ajax_form_public_cursos_mob_validate_fecha_fin(var_fecha_fin, var_script_case_init, do_ajax_form_public_cursos_mob_validate_fecha_fin_cb);
    }, 200);
  } // do_ajax_form_public_cursos_mob_validate_fecha_fin

  function do_ajax_form_public_cursos_mob_validate_fecha_fin_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fecha_fin";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors || ($("#ui-datepicker-div").length && $("#ui-datepicker-div").filter(":visible").length))
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_public_cursos_mob_validate_fecha_fin_cb

  // ---------- Validate horario
  function do_ajax_form_public_cursos_mob_validate_horario()
  {
    var nomeCampo_horario = "horario";
    var var_horario = scAjaxGetFieldText(nomeCampo_horario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_public_cursos_mob_validate_horario(var_horario, var_script_case_init, do_ajax_form_public_cursos_mob_validate_horario_cb);
  } // do_ajax_form_public_cursos_mob_validate_horario

  function do_ajax_form_public_cursos_mob_validate_horario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "horario";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_public_cursos_mob_validate_horario_cb

  // ---------- Validate created_at
  function do_ajax_form_public_cursos_mob_validate_created_at()
  {
    var nomeCampo_created_at = "created_at";
    var var_created_at = scAjaxGetFieldText(nomeCampo_created_at);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_public_cursos_mob_validate_created_at(var_created_at, var_script_case_init, do_ajax_form_public_cursos_mob_validate_created_at_cb);
  } // do_ajax_form_public_cursos_mob_validate_created_at

  function do_ajax_form_public_cursos_mob_validate_created_at_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_public_cursos_mob_validate_created_at_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_public_cursos_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_public_cursos_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id_area = scAjaxGetFieldSelect("id_area");
    var var_nombre_curso = scAjaxGetFieldText("nombre_curso");
    var var_descripcion = scAjaxGetFieldText("descripcion");
    var var_intensidad_horas = scAjaxGetFieldText("intensidad_horas");
    ...
    var var_cupo_maximo = scAjaxGetFieldText("cupo_maximo");
    var var_id_modalidad = scAjaxGetFieldSelect("id_modalidad");
    var var_fecha_inicio = scAjaxGetFieldText("fecha_inicio");
    var var_fecha_fin = scAjaxGetFieldText("fecha_fin");
    var var_horario = scAjaxGetFieldText("horario");
    var var_created_at = scAjaxGetFieldText("created_at");
    ...
    scAjaxProcOn();
    x_ajax_form_public_cursos_mob_submit_form(var_id_area, var_nombre_curso, var_descripcion, var_intensidad_horas, var_sc_field_0, var_id_nivel, var_activo, var_cupo_maximo, var_id_modalidad, var_fecha_inicio, var_fecha_fin, var_horario, var_created_at, var_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_public_cursos_mob_submit_form_cb);
  } // do_ajax_form_public_cursos_mob_submit_form

  function do_ajax_form_public_cursos_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("nombre_curso");
      scAjaxHideErrorDisplay("descripcion");
      scAjaxHideErrorDisplay("intensidad_horas");
      scAjaxHideErrorDisplay("sc_field_0");
      scAjaxHideErrorDisplay("id_nivel");
      scAjaxHideErrorDisplay("activo");
      scAjaxHideErrorDisplay("cupo_maximo");
      scAjaxHideErrorDisplay("id_modalidad");
      scAjaxHideErrorDisplay("fecha_inicio");
      scAjaxHideErrorDisplay("fecha_fin");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_public_cursos_mob_submit_form_cb_after_alert);
  } // do_ajax_form_public_cursos_mob_submit_form_cb
  function do_ajax_form_public_cursos_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_public_cursos_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_public_cursos_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_public_cursos_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_public_cursos_mob_navigate_form();
    }
  }

  function perform_ajax_form_public_cursos_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_public_cursos_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_public_cursos_mob_navigate_form_cb);
  } // do_ajax_form_public_cursos_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_cursos_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_public_cursos_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_public_cursos_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_public_cursos_mob_navigate_form_cb
  function do_ajax_form_public_cursos_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_public_cursos_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_public_cursos_mob_navigate_form_cb_after_alert

  function sc_hide_form_public_cursos_mob_form()
  {
  ...
  ajax_field_list[0] = "id_area";
  ajax_field_list[1] = "nombre_curso";
  ajax_field_list[2] = "descripcion";
  ajax_field_list[3] = "intensidad_horas";
  ajax_field_list[4] = "sc_field_0";
  ajax_field_list[5] = "id_nivel";
  ajax_field_list[6] = "activo";
  ajax_field_list[7] = "cupo_maximo";
  ajax_field_list[8] = "id_modalidad";
  ajax_field_list[9] = "fecha_inicio";
  ajax_field_list[10] = "fecha_fin";
  ajax_field_list[11] = "horario";
  ajax_field_list[12] = "created_at";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "id_area": {"label": "Área", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "nombre_curso": {"label": "Nombre Curso", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    ...
    "intensidad_horas": {"label": "Intensidad Horas", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "sc_field_0": {"label": "año", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "id_nivel": {"label": "Nivel del curso", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "activo": {"label": "Activo", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "cupo_maximo": {"label": "Cupo Máximo", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "id_modalidad": {"label": "Modalidad del curso", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    ...
    "fecha_fin": {"label": "Fecha Fin", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "horario": {"label": "Horario", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "created_at": {"label": "Fecha_Creación", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0}
  };
  ...
  var ajax_field_mult = {
    "id_area": new Array(),
    "nombre_curso": new Array(),
    "descripcion": new Array(),
    "intensidad_horas": new Array(),
    "sc_field_0": new Array(),
    "id_nivel": new Array(),
    "activo": new Array(),
    "cupo_maximo": new Array(),
    "id_modalidad": new Array(),
  ...
  ajax_field_mult["nombre_curso"][1] = "nombre_curso";
  ajax_field_mult["descripcion"][1] = "descripcion";
  ajax_field_mult["intensidad_horas"][1] = "intensidad_horas";
  ajax_field_mult["sc_field_0"][1] = "sc_field_0";
  ajax_field_mult["id_nivel"][1] = "id_nivel";
  ajax_field_mult["activo"][1] = "activo";
  ajax_field_mult["cupo_maximo"][1] = "cupo_maximo";
  ajax_field_mult["id_modalidad"][1] = "id_modalidad";
  ajax_field_mult["fecha_inicio"][1] = "fecha_inicio";
  ajax_field_mult["fecha_fin"][1] = "fecha_fin";
  ...
  var ajax_field_id = {
    ...
    "nombre_curso": new Array("hidden_field_label_nombre_curso", "hidden_field_data_nombre_curso"),
    "descripcion": new Array("hidden_field_label_descripcion", "hidden_field_data_descripcion"),
    "intensidad_horas": new Array("hidden_field_label_intensidad_horas", "hidden_field_data_intensidad_horas"),
    ...
    "cupo_maximo": new Array("hidden_field_label_cupo_maximo", "hidden_field_data_cupo_maximo"),
    "id_modalidad": new Array("hidden_field_label_id_modalidad", "hidden_field_data_id_modalidad"),
    "fecha_inicio": new Array("hidden_field_label_fecha_inicio", "hidden_field_data_fecha_inicio"),
    "fecha_fin": new Array("hidden_field_label_fecha_fin", "hidden_field_data_fecha_fin"),

...
else
{
   ...
   $nm_comando = "SELECT group_id, description FROM public.sec_groups ORDER BY description";
...
if (isset($this->NM_ajax_flag) && $this->NM_ajax_flag)
{
    $original_login = $this->login;
      ...
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      {
          $sc_cmd_dependency = "DELETE FROM public.sec_users_groups WHERE login = '" . $this->login  . "'";
      }
...
$_SESSION['scriptcase']['app_form_edit_users']['contr_erro'] = 'off'; 
      ...
      if ($this->nmgp_opcao == "alterar" || $this->nmgp_opcao == "incluir") 
      {
          ...
          { 
              ...
              if (is_file($this->picture_arq))  
              { 
                  $this->picture = ""; 
                  $NM_val_null[] = "picture";
                  $nm_fp = fopen($this->picture_arq, "r");
                  $picture_buff = fread($nm_fp, filesize($this->picture_arq));
                  fclose($nm_fp);
              }
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          { 
              ...
              {
                  if ($this->picture != "none" && isset($this->picture_arq) && is_file($this->picture_arq))
                  {
             ...
             { 
              ...
              { 
                  if (is_file($this->picture_arq))  
                  { 
                      $_SESSION['scriptcase']['sc_sql_ult_comando'] = "UpdateBlob(" . $this->Ini->nm_tabela . ", picture, " . $picture_buff . ",  login = '$this->login')"; 
                      $rs = $this->Db->UpdateBlob($this->Ini->nm_tabela, "picture", $picture_buff,  "login = '$this->login'", "BYTEA"); 
                      if ($rs === false) 
                      { 
          ...
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "select login, group_id from \"public\".sec_users_groups where login = '$this->login'"; 
          }  
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "select login, group_id from \"public\".sec_users_groups where login = '$this->login'"; 
         ...
         { 
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
              { 
                  $_SESSION['scriptcase']['sc_sql_ult_comando'] = "delete from \"public\".sec_users_groups where login = '" . $sc_campos_sel['login'] . "' and group_id = '" . $sc_campos_sel['group_id'] . "'"; 
              } 
              else 
              { 
                  $_SESSION['scriptcase']['sc_sql_ult_comando'] = "delete from \"public\".sec_users_groups where login = '" . $sc_campos_sel['login'] . "' and group_id = '" . $sc_campos_sel['group_id'] . "'"; 
         ...
         { 
             if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
             { 
                 $_SESSION['scriptcase']['sc_sql_ult_comando'] = "insert into \"public\".sec_users_groups (login, group_id) values ('" . $sc_campos_form['login'] . "', '" . $sc_campos_form['groups'] . "')"; 
             } 
             else 
             { 
                 $_SESSION['scriptcase']['sc_sql_ult_comando'] = "insert into \"public\".sec_users_groups (login, group_id) values ('" . $sc_campos_form['login'] . "', '" . $sc_campos_form['groups'] . "')"; 
          ...
          { 
              foreach ($todo_groups as $cada_groups) 
              {
                  ...
                  { 
                      ...
                      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
                      { 
                          $_SESSION['scriptcase']['sc_sql_ult_comando'] = "insert into \"public\".sec_users_groups (login, group_id) values ('$this->login', '$groupsx')"; 
                      } 
                      else 
                      { 
                          $_SESSION['scriptcase']['sc_sql_ult_comando'] = "insert into \"public\".sec_users_groups (login, group_id) values ('$this->login', '$groupsx')"; 
      ...
      { 
          ...
          { 
              ...
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
              { 
                  $_SESSION['scriptcase']['sc_sql_ult_comando'] = "delete from \"public\".sec_users_groups where login = '$this->login'"; 
              } 
              else 
              { 
                  $_SESSION['scriptcase']['sc_sql_ult_comando'] = "delete from \"public\".sec_users_groups where login = '$this->login'"; 
      ...
      { 
          ...
          { 
              ...
              { 
                  if (!empty($this->picture))
                  { 
                      $this->picture = $this->Db->BlobDecode($this->picture, false, true, "BYTEA");
                  }
              }
              if ($this->Ini->nm_tpbanco == 'pdo_oracle')
              { 
                  if (!empty($this->picture))
                  { 
                      $this->picture = $this->Db->BlobDecode($this->picture, false, true, "BYTEA");
              ...
              { 
                  if (!empty($this->picture))
                  { 
                    if(isset($this->picture) && !empty($this->picture) && is_file($this->picture)) 
                    { 
                     $this->picture = file_get_contents($this->picture);
                    }else 
                    { 
                       $this->picture = ''; 
                    } 

<?php
@session_start() ;
$_SESSION['scriptcase']['grid_public_areas']['sc_process_barr'] = true;
require_once('../grid_public_areas/index.php');
unset($_SESSION['scriptcase']['grid_public_areas']['sc_process_barr']);
$ExportCtrl = new grid_public_areas_export_control;
$ExportCtrl->Export_barr();

class grid_public_areas_export_control
{

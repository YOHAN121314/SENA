...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["PROYECTO_SENA_____grid_public_areas"]))
   {
      unset($_SESSION['session_sec_aplicacao']["PROYECTO_SENA_____grid_public_areas"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_public_areas'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_public_areas']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_public_areas']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_public_areas']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_public_areas']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_public_areas']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_public_areas']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_public_areas']['embutida_filho'] as $ind => $sc_init)
          {

  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_Incripcion_mob" == sTestField)
        {
...
?>
  ...
  // ---------- Validate nombres
  function do_ajax_Incripcion_mob_validate_nombres()
  {
    var nomeCampo_nombres = "nombres";
    var var_nombres = scAjaxGetFieldText(nomeCampo_nombres);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Incripcion_mob_validate_nombres(var_nombres, var_script_case_init, do_ajax_Incripcion_mob_validate_nombres_cb);
  } // do_ajax_Incripcion_mob_validate_nombres

  function do_ajax_Incripcion_mob_validate_nombres_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Incripcion_mob_validate_nombres_cb

  // ---------- Validate apellidos
  function do_ajax_Incripcion_mob_validate_apellidos()
  {
    var nomeCampo_apellidos = "apellidos";
    var var_apellidos = scAjaxGetFieldText(nomeCampo_apellidos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Incripcion_mob_validate_apellidos(var_apellidos, var_script_case_init, do_ajax_Incripcion_mob_validate_apellidos_cb);
  } // do_ajax_Incripcion_mob_validate_apellidos

  function do_ajax_Incripcion_mob_validate_apellidos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Incripcion_mob_validate_apellidos_cb

  // ---------- Validate numero_documento
  function do_ajax_Incripcion_mob_validate_numero_documento()
  {
    var nomeCampo_numero_documento = "numero_documento";
    var var_numero_documento = scAjaxGetFieldText(nomeCampo_numero_documento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Incripcion_mob_validate_numero_documento(var_numero_documento, var_script_case_init, do_ajax_Incripcion_mob_validate_numero_documento_cb);
  } // do_ajax_Incripcion_mob_validate_numero_documento

  function do_ajax_Incripcion_mob_validate_numero_documento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Incripcion_mob_validate_numero_documento_cb

  // ---------- Validate fecha_nacimiento
  function do_ajax_Incripcion_mob_validate_fecha_nacimiento()
  {
    var nomeCampo_fecha_nacimiento = "fecha_nacimiento";
    var var_fecha_nacimiento = scAjaxGetFieldText(nomeCampo_fecha_nacimiento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Incripcion_mob_validate_fecha_nacimiento(var_fecha_nacimiento, var_script_case_init, do_ajax_Incripcion_mob_validate_fecha_nacimiento_cb);
  } // do_ajax_Incripcion_mob_validate_fecha_nacimiento

  function do_ajax_Incripcion_mob_validate_fecha_nacimiento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Incripcion_mob_validate_fecha_nacimiento_cb

  // ---------- Validate email
  function do_ajax_Incripcion_mob_validate_email()
  {
    var nomeCampo_email = "email";
    var var_email = scAjaxGetFieldText(nomeCampo_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Incripcion_mob_validate_email(var_email, var_script_case_init, do_ajax_Incripcion_mob_validate_email_cb);
  } // do_ajax_Incripcion_mob_validate_email

  function do_ajax_Incripcion_mob_validate_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "email";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Incripcion_mob_validate_email_cb

  // ---------- Validate direccion
  function do_ajax_Incripcion_mob_validate_direccion()
  {
    var nomeCampo_direccion = "direccion";
    var var_direccion = scAjaxGetFieldText(nomeCampo_direccion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Incripcion_mob_validate_direccion(var_direccion, var_script_case_init, do_ajax_Incripcion_mob_validate_direccion_cb);
  } // do_ajax_Incripcion_mob_validate_direccion

  function do_ajax_Incripcion_mob_validate_direccion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Incripcion_mob_validate_direccion_cb

  // ---------- Validate telefono
  function do_ajax_Incripcion_mob_validate_telefono()
  {
    var nomeCampo_telefono = "telefono";
    var var_telefono = scAjaxGetFieldText(nomeCampo_telefono);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Incripcion_mob_validate_telefono(var_telefono, var_script_case_init, do_ajax_Incripcion_mob_validate_telefono_cb);
  } // do_ajax_Incripcion_mob_validate_telefono

  function do_ajax_Incripcion_mob_validate_telefono_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Incripcion_mob_validate_telefono_cb

  // ---------- Validate id_curso
  function do_ajax_Incripcion_mob_validate_id_curso()
  {
    var nomeCampo_id_curso = "id_curso";
    var var_id_curso = scAjaxGetFieldSelect(nomeCampo_id_curso);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Incripcion_mob_validate_id_curso(var_id_curso, var_script_case_init, do_ajax_Incripcion_mob_validate_id_curso_cb);
  } // do_ajax_Incripcion_mob_validate_id_curso

  function do_ajax_Incripcion_mob_validate_id_curso_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id_curso";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Incripcion_mob_validate_id_curso_cb

  // ---------- Validate fecha_inscripcion
  function do_ajax_Incripcion_mob_validate_fecha_inscripcion()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Incripcion_mob_validate_fecha_inscripcion(var_fecha_inscripcion, var_script_case_init, do_ajax_Incripcion_mob_validate_fecha_inscripcion_cb);
  } // do_ajax_Incripcion_mob_validate_fecha_inscripcion

  function do_ajax_Incripcion_mob_validate_fecha_inscripcion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Incripcion_mob_validate_fecha_inscripcion_cb

  // ---------- Validate observaciones
  function do_ajax_Incripcion_mob_validate_observaciones()
  {
    var nomeCampo_observaciones = "observaciones";
    var var_observaciones = scAjaxGetFieldText(nomeCampo_observaciones);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Incripcion_mob_validate_observaciones(var_observaciones, var_script_case_init, do_ajax_Incripcion_mob_validate_observaciones_cb);
  } // do_ajax_Incripcion_mob_validate_observaciones

  function do_ajax_Incripcion_mob_validate_observaciones_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Incripcion_mob_validate_observaciones_cb

  // ---------- Event onchange id_curso
  function do_ajax_Incripcion_mob_event_id_curso_onchange()
  {
    var var_id_curso = scAjaxGetFieldSelect("id_curso");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_Incripcion_mob_event_id_curso_onchange(var_id_curso, var_script_case_init, do_ajax_Incripcion_mob_event_id_curso_onchange_cb);
  } // do_ajax_Incripcion_mob_event_id_curso_onchange

  function do_ajax_Incripcion_mob_event_id_curso_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "id_curso";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_Incripcion_mob_event_id_curso_onchange_cb_after_alert);
  } // do_ajax_Incripcion_mob_event_id_curso_onchange_cb
  function do_ajax_Incripcion_mob_event_id_curso_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_Incripcion_mob_event_id_curso_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_Incripcion_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_Incripcion_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_Incripcion_mob_submit_form(var_nombres, var_apellidos, var_numero_documento, var_fecha_nacimiento, var_email, var_direccion, var_telefono, var_id_curso, var_fecha_inscripcion, var_observaciones, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_Incripcion_mob_submit_form_cb);
  } // do_ajax_Incripcion_mob_submit_form

  function do_ajax_Incripcion_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("id_curso");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_Incripcion_mob_submit_form_cb_after_alert);
  } // do_ajax_Incripcion_mob_submit_form_cb
  function do_ajax_Incripcion_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_Incripcion_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_Incripcion_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_Incripcion_mob_navigate_form, function() {});
    } else {
      perform_ajax_Incripcion_mob_navigate_form();
    }
  }

  function perform_ajax_Incripcion_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_Incripcion_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_Incripcion_mob_navigate_form_cb);
  } // do_ajax_Incripcion_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['Incripcion_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_Incripcion_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_Incripcion_mob_navigate_form_cb_after_alert);
  } // do_ajax_Incripcion_mob_navigate_form_cb
  function do_ajax_Incripcion_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_Incripcion_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_Incripcion_mob_navigate_form_cb_after_alert

  function sc_hide_Incripcion_mob_form()
  {
  ...
  ajax_field_list[7] = "id_curso";
  ajax_field_list[8] = "fecha_inscripcion";
  ...
  var ajax_error_list = {
    "nombres": {"label": "Nombres", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "apellidos": {"label": "Apellidos", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "numero_documento": {"label": " Documento de Identidad", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "fecha_nacimiento": {"label": "Fecha de Nacimiento", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "email": {"label": "Email", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "direccion": {"label": "Dirección", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "telefono": {"label": "Teléfono", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "id_curso": {"label": "Curso", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "fecha_inscripcion": {"label": "Fecha Inscripcion", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
  ...
  ajax_field_mult["id_curso"][1] = "id_curso";
  ...
  var ajax_field_id = {
    ...
    "id_curso": new Array("hidden_field_label_id_curso", "hidden_field_data_id_curso"),

...
$old_error_handler = set_error_handler("Incripcion_scriptcase_error_handler");

function Incripcion_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe="", $err_usr=false)
{
    ...
    if (isset($_SESSION['scriptcase']['Incripcion']['contr_erro']) && $_SESSION['scriptcase']['Incripcion']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_Incripcion->contr_Incripcion->Apl_com_erro = true;
            if ($inicial_Incripcion->contr_Incripcion->NM_ajax_flag)
            {
                $inicial_Incripcion->contr_Incripcion->NM_ajax_info['errList']['geral_Incripcion'][] = $msg;
                return;
            }
            Incripcion_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function Incripcion_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['Incripcion'])  && '' != $_SESSION['scriptcase']['error_icon']['Incripcion'])  ? $_SESSION['scriptcase']['error_icon']['Incripcion']  : "";
        $sCloseIcon      = (isset($_SESSION['scriptcase']['error_close']['Incripcion']) && '' != $_SESSION['scriptcase']['error_close']['Incripcion']) ? $_SESSION['scriptcase']['error_close']['Incripcion'] : "<td><input class=\"scButton_default\" type=\"button\" onClick=\"document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false\" value=\"X\" /></td>";

        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['Incripcion']) && '' != $_SESSION['scriptcase']['error_span_title']['Incripcion']) ? $_SESSION['scriptcase']['error_span_title']['Incripcion'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['Incripcion']) && '' != $_SESSION['scriptcase']['error_icon_title']['Incripcion']) ? $_SESSION['scriptcase']['error_icon_title']['Incripcion'] : '';
?>

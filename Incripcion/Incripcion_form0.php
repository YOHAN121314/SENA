...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2-4.0.6/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Incripcion']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>Incripcion/Incripcion_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("Incripcion_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Incripcion']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['Incripcion']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Incripcion']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['Incripcion']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Incripcion']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['Incripcion']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Incripcion']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['Incripcion']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('Incripcion_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['Incripcion']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['Incripcion']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['Incripcion']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['Incripcion']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['Incripcion']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['Incripcion']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['Incripcion']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Incripcion']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['Incripcion']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Incripcion']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Incripcion']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Incripcion']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Incripcion']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Incripcion']['link_info']['remove_border']) {
...
<?php
 include_once("Incripcion_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['Incripcion']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['Incripcion']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['Incripcion'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['Incripcion'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Incripcion']['btn_disabled']['new']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['Incripcion']['btn_disabled']['new']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Incripcion']['btn_label']['new']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['Incripcion']['btn_label']['new']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['Incripcion']['btn_label']['new'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Incripcion']['btn_disabled']['insert']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['Incripcion']['btn_disabled']['insert']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Incripcion']['btn_label']['insert']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['Incripcion']['btn_label']['insert']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['Incripcion']['btn_label']['insert'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Incripcion']['btn_disabled']['breload']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['Incripcion']['btn_disabled']['breload']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Incripcion']['btn_label']['breload']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['Incripcion']['btn_label']['breload']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['Incripcion']['btn_label']['breload'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Incripcion']['btn_disabled']['volver']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['Incripcion']['btn_disabled']['volver']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Incripcion']['btn_label']['volver']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['Incripcion']['btn_label']['volver']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['Incripcion']['btn_label']['volver'];
        }
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_numero_documento_label" id="hidden_field_label_numero_documento" style="<?php echo $sStyleHidden_numero_documento; ?>"><span id="id_label_numero_documento"><?php echo $this->nm_new_label['numero_documento']; ?></span></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_id_curso_label" id="hidden_field_label_id_curso" style="<?php echo $sStyleHidden_id_curso; ?>"><span id="id_label_id_curso"><?php echo $this->nm_new_label['id_curso']; ?></span></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_fecha_inscripcion_label" id="hidden_field_label_fecha_inscripcion" style="<?php echo $sStyleHidden_fecha_inscripcion; ?>"><span id="id_label_fecha_inscripcion"><?php echo $this->nm_new_label['fecha_inscripcion']; ?></span></TD>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Incripcion']['btn_disabled']['birpara']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['Incripcion']['btn_disabled']['birpara']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Incripcion']['btn_label']['birpara']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['Incripcion']['btn_label']['birpara']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['Incripcion']['btn_label']['birpara'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Incripcion']['btn_disabled']['first']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['Incripcion']['btn_disabled']['first']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Incripcion']['btn_label']['first']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['Incripcion']['btn_label']['first']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['Incripcion']['btn_label']['first'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Incripcion']['btn_disabled']['back']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['Incripcion']['btn_disabled']['back']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Incripcion']['btn_label']['back']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['Incripcion']['btn_label']['back']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['Incripcion']['btn_label']['back'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Incripcion']['btn_disabled']['forward']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['Incripcion']['btn_disabled']['forward']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Incripcion']['btn_label']['forward']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['Incripcion']['btn_label']['forward']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['Incripcion']['btn_label']['forward'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Incripcion']['btn_disabled']['last']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['Incripcion']['btn_disabled']['last']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Incripcion']['btn_label']['last']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['Incripcion']['btn_label']['last']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['Incripcion']['btn_label']['last'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Incripcion']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['Incripcion']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Incripcion']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['Incripcion']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['Incripcion']['btn_label']['exit'];
        }
?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['Incripcion']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['Incripcion']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['Incripcion']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['Incripcion']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['Incripcion']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['Incripcion']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['Incripcion']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['Incripcion']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['Incripcion']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Incripcion']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['Incripcion']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("Incripcion");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("Incripcion");
 parent.scAjaxDetailHeight("Incripcion", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['Incripcion']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">

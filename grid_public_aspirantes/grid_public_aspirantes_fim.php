...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["PROYECTO_SENA_____grid_public_aspirantes"]))
   {
      unset($_SESSION['session_sec_aplicacao']["PROYECTO_SENA_____grid_public_aspirantes"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_public_aspirantes'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_public_aspirantes']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_public_aspirantes']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_public_aspirantes']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_public_aspirantes']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_public_aspirantes']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_public_aspirantes</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_public_aspirantes']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_public_aspirantes']['embutida_filho'] as $ind => $sc_init)
          {

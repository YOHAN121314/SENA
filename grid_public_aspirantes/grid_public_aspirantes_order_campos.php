<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_public_aspirantes']['glo_nm_path_imag_temp'] . "/sc_apl_default_PROYECTO_SENA.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_public_aspirantes_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_public_aspirantes_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_public_aspirantes']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_public_aspirantes']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["nombre"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_public_aspirantes']['labels']["nombre"])) ? $_SESSION['sc_session'][$sc_init]['grid_public_aspirantes']['labels']["nombre"] : "Nombre";
   $tab_ger_campos['apellido'] = "on";
   $tab_def_campos['apellido'] = "apellido";
   $tab_labels["apellido"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_public_aspirantes']['labels']["apellido"])) ? $_SESSION['sc_session'][$sc_init]['grid_public_aspirantes']['labels']["apellido"] : "Apellido";
   $tab_ger_campos['documento_identidad'] = "on";
   $tab_def_campos['documento_identidad'] = "documento_identidad";
   $tab_labels["documento_identidad"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_public_aspirantes']['labels']["documento_identidad"])) ? $_SESSION['sc_session'][$sc_init]['grid_public_aspirantes']['labels']["documento_identidad"] : "Documento Identidad";
   $tab_ger_campos['email'] = "on";
   $tab_def_campos['email'] = "email";
   $tab_labels["email"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_public_aspirantes']['labels']["email"])) ? $_SESSION['sc_session'][$sc_init]['grid_public_aspirantes']['labels']["email"] : "Email";
   $tab_ger_campos['telefono'] = "on";
   $tab_def_campos['telefono'] = "telefono";
   $tab_labels["telefono"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_public_aspirantes']['labels']["telefono"])) ? $_SESSION['sc_session'][$sc_init]['grid_public_aspirantes']['labels']["telefono"] : "Telefono";
   ...
   $tab_labels["estado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_public_aspirantes']['labels']["estado"])) ? $_SESSION['sc_session'][$sc_init]['grid_public_aspirantes']['labels']["estado"] : "Estado";
   $tab_ger_campos['fecha_nacimiento'] = "on";
   $tab_def_campos['fecha_nacimiento'] = "fecha_nacimiento";
   $tab_labels["fecha_nacimiento"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_public_aspirantes']['labels']["fecha_nacimiento"])) ? $_SESSION['sc_session'][$sc_init]['grid_public_aspirantes']['labels']["fecha_nacimiento"] : "Fecha Nacimiento";
   $tab_ger_campos['direccion'] = "on";
   $tab_def_campos['direccion'] = "direccion";
   $tab_labels["direccion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_public_aspirantes']['labels']["direccion"])) ? $_SESSION['sc_session'][$sc_init]['grid_public_aspirantes']['labels']["direccion"] : "Direccion";
   $tab_ger_campos['created_at'] = "on";
   $tab_def_campos['created_at'] = "created_at";
   $tab_labels["created_at"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_public_aspirantes']['labels']["created_at"])) ? $_SESSION['sc_session'][$sc_init]['grid_public_aspirantes']['labels']["created_at"] : "Fecha de creacion";
   $tab_ger_campos['updated_at'] = "on";
   $tab_def_campos['updated_at'] = "updated_at";
   $tab_labels["updated_at"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_public_aspirantes']['labels']["updated_at"])) ? $_SESSION['sc_session'][$sc_init]['grid_public_aspirantes']['labels']["updated_at"] : "Fecha de actualizacion";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_public_aspirantes']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_public_aspirantes']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_public_aspirantes']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_public_aspirantes']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_public_aspirantes']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_public_aspirantes']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_public_aspirantes']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_public_aspirantes']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_public_aspirantes']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_public_aspirantes']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_public_aspirantes']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_public_aspirantes']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_public_aspirantes_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_public_aspirantes']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_public_aspirantes']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_public_aspirantes']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_public_aspirantes']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_public_aspirantes']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {

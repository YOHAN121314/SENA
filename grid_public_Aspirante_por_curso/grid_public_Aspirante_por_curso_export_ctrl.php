<?php
@session_start() ;
$_SESSION['scriptcase']['grid_public_Aspirante_por_curso']['sc_process_barr'] = true;
require_once('../grid_public_Aspirante_por_curso/index.php');
unset($_SESSION['scriptcase']['grid_public_Aspirante_por_curso']['sc_process_barr']);
$ExportCtrl = new grid_public_Aspirante_por_curso_export_control;
$ExportCtrl->Export_barr();

class grid_public_Aspirante_por_curso_export_control
{

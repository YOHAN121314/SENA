...
<?php
   ...
   $Ord_Cmp = new grid_public_Aspirante_por_curso_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_public_Aspirante_por_curso_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_public_Aspirante_por_curso']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_public_Aspirante_por_curso']['ordem_select_orig'] = array();
   }
   ...
   if ($use_alias == "S")
   {
       $tab_def_campos['ar_descripcion'] = "ar_descripcion";
   }
   else
   {
       $tab_def_campos['ar_descripcion'] = "ar.descripcion";
   }
   $tab_labels["ar_descripcion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_public_Aspirante_por_curso']['labels']["ar_descripcion"])) ? $_SESSION['sc_session'][$sc_init]['grid_public_Aspirante_por_curso']['labels']["ar_descripcion"] : "Área";
   ...
   $tab_labels["c_nombre_curso"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_public_Aspirante_por_curso']['labels']["c_nombre_curso"])) ? $_SESSION['sc_session'][$sc_init]['grid_public_Aspirante_por_curso']['labels']["c_nombre_curso"] : "Nombre del Curso";
   $tab_ger_campos['a_nombre'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['a_nombre'] = "a_nombre";
   }
   else
   {
       $tab_def_campos['a_nombre'] = "a.nombre";
   }
   $tab_labels["a_nombre"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_public_Aspirante_por_curso']['labels']["a_nombre"])) ? $_SESSION['sc_session'][$sc_init]['grid_public_Aspirante_por_curso']['labels']["a_nombre"] : " Aspirante";
   $tab_ger_campos['i_fecha_inscripcion'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['i_fecha_inscripcion'] = "i_fecha_inscripcion";
   }
   else
   {
       $tab_def_campos['i_fecha_inscripcion'] = "i.fecha_inscripcion";
   }
   $tab_labels["i_fecha_inscripcion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_public_Aspirante_por_curso']['labels']["i_fecha_inscripcion"])) ? $_SESSION['sc_session'][$sc_init]['grid_public_Aspirante_por_curso']['labels']["i_fecha_inscripcion"] : "Fecha Inscripción";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_public_Aspirante_por_curso']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_public_Aspirante_por_curso']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_public_Aspirante_por_curso']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_public_Aspirante_por_curso']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_public_Aspirante_por_curso']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_public_Aspirante_por_curso']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_public_Aspirante_por_curso']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_public_Aspirante_por_curso']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_public_Aspirante_por_curso']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_public_Aspirante_por_curso']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_public_Aspirante_por_curso']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_public_Aspirante_por_curso']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_public_Aspirante_por_curso_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_public_Aspirante_por_curso']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_public_Aspirante_por_curso']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_public_Aspirante_por_curso']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_public_Aspirante_por_curso']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_public_Aspirante_por_curso']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {

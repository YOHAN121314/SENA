...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["PROYECTO_SENA_____grid_public_Aspirante_por_curso"]))
   {
      unset($_SESSION['session_sec_aplicacao']["PROYECTO_SENA_____grid_public_Aspirante_por_curso"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_public_Aspirante_por_curso']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_public_Aspirante_por_curso']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_public_Aspirante_por_curso']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_public_Aspirante_por_curso']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_public_Aspirante_por_curso']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_public_Aspirante_por_curso</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_public_Aspirante_por_curso']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_public_Aspirante_por_curso']['embutida_filho'] as $ind => $sc_init)
          {

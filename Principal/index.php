<?php
   include_once('Principal_session.php');
   @ini_set('session.cookie_httponly', 1);
   @ini_set('session.use_only_cookies', 1);
   @ini_set('session.cookie_secure', 0);
   @session_start() ;
   $_SESSION['scriptcase']['Principal']['glo_nm_perfil']          = "conn_postgres";
   $_SESSION['scriptcase']['Principal']['glo_nm_path_prod']       = "";
   $_SESSION['scriptcase']['Principal']['glo_nm_path_conf']       = "";
   $_SESSION['scriptcase']['Principal']['glo_nm_path_imagens']    = "";
   $_SESSION['scriptcase']['Principal']['glo_nm_path_imag_temp']  = "";
   $_SESSION['scriptcase']['Principal']['glo_nm_path_cache']      = "";
   $_SESSION['scriptcase']['Principal']['glo_nm_path_doc']        = "";
    ...
    //check prod
    if(empty($_SESSION['scriptcase']['Principal']['glo_nm_path_prod']))
    {
            /*check prod*/$_SESSION['scriptcase']['Principal']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
    }
    //check img
    if(empty($_SESSION['scriptcase']['Principal']['glo_nm_path_imagens']))
    {
            /*check img*/$_SESSION['scriptcase']['Principal']['glo_nm_path_imagens'] = $str_path_apl_url . "_lib/file/img";
    }
    //check tmp
    if(empty($_SESSION['scriptcase']['Principal']['glo_nm_path_imag_temp']))
    {
            /*check tmp*/$_SESSION['scriptcase']['Principal']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
    }
    //check cache
    if(empty($_SESSION['scriptcase']['Principal']['glo_nm_path_cache']))
    {
            /*check tmp*/$_SESSION['scriptcase']['Principal']['glo_nm_path_cache'] = $str_path_apl_dir . "_lib/file/cache";
    }
    //check doc
    if(empty($_SESSION['scriptcase']['Principal']['glo_nm_path_doc']))
    {
            /*check doc*/$_SESSION['scriptcase']['Principal']['glo_nm_path_doc'] = $str_path_apl_dir . "_lib/file/doc";
    }
...
//
   function init($Tp_init = "")
   {
      ...
      $_SESSION['sc_session'][$this->sc_page]['Principal']['decimal_db'] = "."; 
      $this->nm_cod_apl      = "Principal"; 
      $this->nm_nome_apl     = ""; 
      $this->nm_seguranca    = ""; 
      ...
      $this->nm_dt_criacao   = "20250917"; 
      $this->nm_hr_criacao   = "184214"; 
...
// 
      ...
      $this->sc_protocolo    = "";
      $this->path_prod       = $_SESSION['scriptcase']['Principal']['glo_nm_path_prod'];
      $this->path_conf       = $_SESSION['scriptcase']['Principal']['glo_nm_path_conf'];
      $this->path_imagens    = $_SESSION['scriptcase']['Principal']['glo_nm_path_imagens'];
      $this->path_imag_temp  = $_SESSION['scriptcase']['Principal']['glo_nm_path_imag_temp'];
      $this->path_cache  = $_SESSION['scriptcase']['Principal']['glo_nm_path_cache'];
      $this->path_doc        = $_SESSION['scriptcase']['Principal']['glo_nm_path_doc'];
      ...
      if (!isset($_SESSION['scriptcase']['Principal']['save_session']['save_grid_state_session']))
      { 
          $_SESSION['scriptcase']['Principal']['save_session']['save_grid_state_session'] = false;
          $_SESSION['scriptcase']['Principal']['save_session']['data'] = '';
      } 
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['Principal']['sub_cons_schema_all']))
      { 
         $this->str_schema_all    = $_SESSION['sc_session'][$this->sc_page]['Principal']['sub_cons_schema_all'];
         $this->str_schema_filter = $_SESSION['sc_session'][$this->sc_page]['Principal']['sub_cons_schema_filter'];
      } 
      ...
      $this->path_aplicacao  = substr($this->path_aplicacao, 0, strrpos($this->path_aplicacao, '/')) . '/Principal';
      ...
      $_SESSION['sc_session'][$this->sc_page]['Principal']['path_grid_sv'] = $this->root . substr($this->path_prod, 0, $pos_path) . "/conf/grid_sv/";
      ...
      if (isset($_SESSION['scriptcase']['Principal']['session_timeout']['lang'])) {
          $this->str_lang = $_SESSION['scriptcase']['Principal']['session_timeout']['lang'];
      }
      elseif (!isset($_SESSION['scriptcase']['Principal']['actual_lang']) || $_SESSION['scriptcase']['Principal']['actual_lang'] != $this->str_lang) {
          $_SESSION['scriptcase']['Principal']['actual_lang'] = $this->str_lang;
      ...
      {
          include_once("Principal_json.php");
      }
      $this->SC_Link_View = (isset($_SESSION['sc_session'][$this->sc_page]['Principal']['SC_Link_View'])) ? $_SESSION['sc_session'][$this->sc_page]['Principal']['SC_Link_View'] : false;
      if (isset($_GET['SC_Link_View']) && !empty($_GET['SC_Link_View']) && is_numeric($_GET['SC_Link_View']))
      {
          if ($_SESSION['sc_session'][$this->sc_page]['Principal']['embutida'])
          {
              $this->SC_Link_View = true;
              $_SESSION['sc_session'][$this->sc_page]['Principal']['SC_Link_View'] = true;
          }
      }
    ...
    $out1_img_cache = $_SESSION['scriptcase']['Principal']['glo_nm_path_imag_temp'] . $file_name;
    $orig_img = $_SESSION['scriptcase']['Principal']['glo_nm_path_imag_temp']. '/'.basename($_POST['AjaxCheckImg']);
    ...
    if(file_exists($out1_img_cache)){
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['Principal']['ancor_save'] = $_POST['ancor_save'];
...
<?php
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['Principal']['dashboard_info']['under_dashboard']))
      {
          $_SESSION['sc_session'][$this->sc_page]['Principal']['dashboard_info']['under_dashboard'] = false;
          $_SESSION['sc_session'][$this->sc_page]['Principal']['dashboard_info']['dashboard_app']   = '';
          $_SESSION['sc_session'][$this->sc_page]['Principal']['dashboard_info']['own_widget']      = '';
          $_SESSION['sc_session'][$this->sc_page]['Principal']['dashboard_info']['parent_widget']   = '';
          $_SESSION['sc_session'][$this->sc_page]['Principal']['dashboard_info']['compact_mode']    = false;
          $_SESSION['sc_session'][$this->sc_page]['Principal']['dashboard_info']['remove_margin']   = false;
          $_SESSION['sc_session'][$this->sc_page]['Principal']['dashboard_info']['remove_border']   = false;
      }
      if (isset($_GET['under_dashboard']) && 1 == $_GET['under_dashboard'])
      {
          if (isset($_GET['own_widget']) && 'dbifrm_widget' == substr($_GET['own_widget'], 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['Principal']['dashboard_info']['own_widget'] = $_GET['own_widget'];
              $_SESSION['sc_session'][$this->sc_page]['Principal']['dashboard_info']['under_dashboard'] = true;
              if (isset($_GET['dashboard_app'])) {
                  $_SESSION['sc_session'][$this->sc_page]['Principal']['dashboard_info']['dashboard_app'] = $_GET['dashboard_app'];
              }
              if (isset($_GET['parent_widget'])) {
                  $_SESSION['sc_session'][$this->sc_page]['Principal']['dashboard_info']['parent_widget'] = $_GET['parent_widget'];
              }
              if (isset($_GET['compact_mode'])) {
                  $_SESSION['sc_session'][$this->sc_page]['Principal']['dashboard_info']['compact_mode'] = 1 == $_GET['compact_mode'];
              }
              if (isset($_GET['remove_margin'])) {
                  $_SESSION['sc_session'][$this->sc_page]['Principal']['dashboard_info']['remove_margin'] = 1 == $_GET['remove_margin'];
              }
              if (isset($_GET['remove_border'])) {
                  $_SESSION['sc_session'][$this->sc_page]['Principal']['dashboard_info']['remove_border'] = 1 == $_GET['remove_border'];
              }
          }
      }
      elseif (isset($under_dashboard) && 1 == $under_dashboard)
      {
          if (isset($own_widget) && 'dbifrm_widget' == substr($own_widget, 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['Principal']['dashboard_info']['own_widget'] = $own_widget;
              $_SESSION['sc_session'][$this->sc_page]['Principal']['dashboard_info']['under_dashboard'] = true;
              if (isset($dashboard_app)) {
                  $_SESSION['sc_session'][$this->sc_page]['Principal']['dashboard_info']['dashboard_app'] = $dashboard_app;
              }
              if (isset($parent_widget)) {
                  $_SESSION['sc_session'][$this->sc_page]['Principal']['dashboard_info']['parent_widget'] = $parent_widget;
              }
              if (isset($compact_mode)) {
                  $_SESSION['sc_session'][$this->sc_page]['Principal']['dashboard_info']['compact_mode'] = 1 == $compact_mode;
              }
              if (isset($remove_margin)) {
                  $_SESSION['sc_session'][$this->sc_page]['Principal']['dashboard_info']['remove_margin'] = 1 == $remove_margin;
              }
              if (isset($remove_border)) {
                  $_SESSION['sc_session'][$this->sc_page]['Principal']['dashboard_info']['remove_border'] = 1 == $remove_border;
              }
          }
      }
      if (!isset($_SESSION['sc_session'][$this->sc_page]['Principal']['dashboard_info']['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['Principal']['dashboard_info']['maximized'] = false;
      }
      if (isset($_GET['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['Principal']['dashboard_info']['maximized'] = 1 == $_GET['maximized'];
      }
      if ($_SESSION['sc_session'][$this->sc_page]['Principal']['dashboard_info']['under_dashboard'])
      {
          $sTmpDashboardApp = $_SESSION['sc_session'][$this->sc_page]['Principal']['dashboard_info']['dashboard_app'];
          if ('' != $sTmpDashboardApp && isset($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["Principal"]))
          {
              foreach ($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["Principal"] as $sTmpTargetLink => $sTmpTargetWidget)
              {
        ...
        if (isset($link_compact_mode) && 'ok' == $link_compact_mode) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['Principal']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['Principal']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['Principal']['link_info']['compact_mode'] = true;
        }
        if (isset($link_remove_margin) && 'ok' == $link_remove_margin) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['Principal']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['Principal']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['Principal']['link_info']['remove_margin'] = true;
        }
        if (isset($link_remove_border) && 'ok' == $link_remove_border) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['Principal']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['Principal']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['Principal']['link_info']['remove_border'] = true;
        }

      if (!isset($_SESSION['sc_session'][$this->sc_page]['Principal']['responsive_chart']))
      {
          $_SESSION['sc_session'][$this->sc_page]['Principal']['responsive_chart'] = array(
              'enabled' => false,
              'active'  => false,
          );
      }
      if ($_SESSION['sc_session'][$this->sc_page]['Principal']['responsive_chart']['enabled'])
      {
          $_SESSION['sc_session'][$this->sc_page]['Principal']['responsive_chart']['active'] = true;
      }
      elseif ($_SESSION['sc_session'][$this->sc_page]['Principal']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->sc_page]['Principal']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->sc_page]['Principal']['dashboard_info']['maximized'])
      {
          $_SESSION['sc_session'][$this->sc_page]['Principal']['responsive_chart']['active'] = true;
      }
      else
      {
          $_SESSION['sc_session'][$this->sc_page]['Principal']['responsive_chart']['active'] = false;
      }
      if ($Tp_init == "Path_sub")
      {
          return;
      ...
      if (!is_file($this->root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
      {
          ...
          unset($_SESSION['scriptcase']['Principal']['glo_nm_conexao']);
      }
      ...
      if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['Principal']['session_timeout']['redir']))
      {
      ...
      $_SESSION['sc_session'][$this->sc_page]['Principal']['path_doc'] = $this->path_doc; 
      ...
      if (!is_dir($this->root . $this->path_prod))
      {
          ...
          echo " </tr>";
          echo "</table>";
          if (!$_SESSION['sc_session'][$script_case_init]['Principal']['iframe_menu'] && (!isset($_SESSION['sc_session'][$script_case_init]['Principal']['sc_outra_jan']) || !$_SESSION['sc_session'][$script_case_init]['Principal']['sc_outra_jan'])) 
          { 
...
// 
      include_once($this->path_aplicacao . "Principal_erro.class.php"); 
      $this->Erro = new Principal_erro();
      include_once($this->path_adodb . "/adodb.inc.php"); 
      $this->sc_Include($this->path_libs . "/nm_sec_prod.php", "F", "nm_reg_prod") ; 
      $this->sc_Include($this->path_libs . "/nm_ini_perfil.php", "F", "perfil_lib") ; 
// 
 if(function_exists('set_php_timezone')) set_php_timezone('Principal'); 
// 
      ...
      if (isset($_SESSION['scriptcase']['Principal']['session_timeout']['redir'])) {
          ...
          if ($_SESSION['scriptcase']['Principal']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "  </HEAD>\r\n";
              $SS_cod_html .= "   <body>\r\n";
          }
          else {
              ...
              $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['Principal']['session_timeout']['redir'] . "');\">\r\n";
              $SS_cod_html .= "     </form>\r\n";
          ...
          if ($_SESSION['scriptcase']['Principal']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['Principal']['session_timeout']['redir'] . "');\r\n";
          }
          ...
          $SS_cod_html .= " </body>\r\n";
          $SS_cod_html .= "</HTML>\r\n";
          unset($_SESSION['scriptcase']['Principal']['session_timeout']);
          unset($_SESSION['sc_session']);
      }
      ...
      $_SESSION['sc_session'][$this->sc_page]['Principal']['seq_dir'] = 0; 
      $_SESSION['sc_session'][$this->sc_page]['Principal']['sub_dir'] = array(); 
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
      $this->conectDB();
   ...
   function prep_conect()
   {
      if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
      {
          ...
          {
              if (isset($_SESSION['scriptcase']['Principal']['glo_nm_conexao']) && $_SESSION['scriptcase']['Principal']['glo_nm_conexao'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['Principal']['glo_nm_conexao'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['Principal']['glo_nm_perfil']) && $_SESSION['scriptcase']['Principal']['glo_nm_perfil'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['Principal']['glo_nm_perfil'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['Principal']['glo_con_' . $NM_con_orig]))
              {
                  $_SESSION['scriptcase']['Principal']['glo_con_' . $NM_con_orig] = $NM_con_dest;
              }
          }
      }
      $con_devel             = (isset($_SESSION['scriptcase']['Principal']['glo_nm_conexao'])) ? $_SESSION['scriptcase']['Principal']['glo_nm_conexao'] : ""; 
      $perfil_trab           = ""; 
      $this->nm_falta_var    = ""; 
      $this->nm_falta_var_db = ""; 
      $nm_crit_perfil        = false;
      if (isset($_SESSION['scriptcase']['Principal']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['Principal']['glo_nm_conexao']))
      {
      ...
      if (isset($_SESSION['scriptcase']['Principal']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['Principal']['glo_nm_perfil']))
      {
          $perfil_trab = $_SESSION['scriptcase']['Principal']['glo_nm_perfil'];
      }
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['Principal']['embutida_init']) || !$_SESSION['sc_session'][$this->sc_page]['Principal']['embutida_init']) 
      {
      }
// 
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['Principal']['decimal_db'] = $_SESSION['scriptcase']['glo_decimal_db']; 
      }
      if (isset($_SESSION['scriptcase']['glo_date_separator']) && !empty($_SESSION['scriptcase']['glo_date_separator']))
      {
          ...
          if (strlen($SC_temp) == 2)
          {
              $_SESSION['sc_session'][$this->sc_page]['Principal']['SC_sep_date']  = substr($SC_temp, 0, 1); 
              $_SESSION['sc_session'][$this->sc_page]['Principal']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
          }
          else
           {
              $_SESSION['sc_session'][$this->sc_page]['Principal']['SC_sep_date']  = $SC_temp; 
              $_SESSION['sc_session'][$this->sc_page]['Principal']['SC_sep_date1'] = $SC_temp; 
          }
          $this->date_delim  = $_SESSION['sc_session'][$this->sc_page]['Principal']['SC_sep_date'];
          $this->date_delim1 = $_SESSION['sc_session'][$this->sc_page]['Principal']['SC_sep_date1'];
      }
// 
...
<?php
   ...
   function conectDB()
   {
      ...
      if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['Principal']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['Principal']['glo_nm_conexao']))
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['Principal']['glo_nm_conexao'], $this->root . $this->path_prod, 'PROYECTO_SENA', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['Principal']['embutida']) || !$_SESSION['sc_session'][$this->sc_page]['Principal']['embutida'])
      {
...
// 
   ...
   function sc_Sql_Protect($var, $tp, $conex="")
   {
       ...
       if ($tp == "date")
       {
           ...
           if (isset($_SESSION['sc_session'][$this->sc_page]['Principal']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->sc_page]['Principal']['SC_sep_date']))
           {
               $delim  = $_SESSION['sc_session'][$this->sc_page]['Principal']['SC_sep_date'];
               $delim1 = $_SESSION['sc_session'][$this->sc_page]['Principal']['SC_sep_date1'];
           }
   ...
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['Principal']['SC_Gb_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['Principal']['SC_Gb_date_format'][$GB][$cmp] : "";
   }

   function Get_Gb_prefix_date_format($GB, $cmp)
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['Principal']['SC_Gb_prefix_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['Principal']['SC_Gb_prefix_date_format'][$GB][$cmp] : "";
   }
...
//----- 
   function controle()
   {
      ...
      $this->Ini = new Principal_ini(); 
      $this->Ini->init();
      $this->Change_Menu = false;
      if (isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Principal']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['Principal']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['Principal']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['Principal'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['Principal']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['Principal']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('Principal') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['Principal']['label'] = "" . $this->Ini->Nm_lang['lang_othr_blank_title'] . "";
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['Principal']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['Principal']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['Principal']['exit'];
      ...
      $this->Db = $this->Ini->Db; 
      include_once($this->Ini->path_aplicacao . "Principal_erro.class.php"); 
      $this->Erro      = new Principal_erro();
      $this->Erro->Ini = $this->Ini;
//
      header("X-XSS-Protection: 1; mode=block");
      header("X-Frame-Options: SAMEORIGIN");
      $_SESSION['scriptcase']['Principal']['contr_erro'] = 'on';
 ?>
...
<html lang="es">
	<head>
		...
		<style>
			...
			.navbar-nav .dropdown-item:hover {
				background-color: #09857f !important;
				color: #fff !important;
			}
	...
	<body>
		...
		<header>
			<div class="container-main">
				...
				<div class="container-text d-flex align-items-center">
					<img src="https://www.sena.edu.co/Style%20Library/alayout/images/logoSena.png" alt="Logo.png">
					<h3><strong>FORMACIÓN PARA EL TRABAJO Y EL DESARROLLO HUMANO</strong></h3>
				</div>
					...
					<div class="container-fluid p-0">
						<ul class="navbar-nav me-auto">
							<li class="nav-item dropdown">
								<a class="nav-link dropdown-toggle text-white fw-bold" href="#" id="menuOpciones" role="button" data-bs-toggle="dropdown" aria-expanded="false">
									Opciones
								</a>
								<ul class="dropdown-menu dropdown-menu-dark bg-dark" aria-labelledby="menuOpciones">
									<li><a class="dropdown-item" href="../app_Login/app_Login.php"><i class="fa-solid fa-right-to-bracket me-2"></i>Acceder</a></li>
									<li><a class="dropdown-item" href="../Incripcion/Incripcion.php"><i class="fa-solid fa-user-plus me-2"></i>Registrar</a></li>
								</ul>
							</li>
						</ul>
					</div>
		...
		<!-- CARRUSEL -->
		<div id="senaCarousel" class="carousel slide mt-3" data-bs-ride="carousel">
			...
			<div class="d-flex justify-content-center">
				<div id="carouselExample" class="carousel slide" data-bs-ride="carousel" style="max-width: 2200px;">
					<div class="carousel-inner">
						<div class="carousel-item active">
							<a href="https://ejecucionformacion.sena.edu.co/cursos-cortos" target="_blank">
								<img src="<?php echo sc_url_library('prj', 'Login', 'login/img/banner.png') ?>" class="d-block img-fluid mx-auto" alt="imagen 1">
								<div class="carousel-caption d-none d-md-block bg-dark bg-opacity-50 rounded">
									<h4><strong>SENA Colombia</strong></h4>
									<p><strong>Educación gratuita y de calidad para todos los colombianos.</strong></p>
								</div>
							</a>
						</div>

						<div class="carousel-item">
							<a href="https://betowa.sena.edu.co/oferta/gestion-de-entornos-virtuales-metodologias-y-herramientas-para-la-formacion-en-el-sena?enrollCourse=3201387&programId=225270" target="_blank">
								<img src="<?php echo sc_url_library('prj', 'Login', 'login/img/imagen2.png') ?>" class="d-block img-fluid mx-auto" alt="imagen 2">
								<div class="carousel-caption d-none d-md-block bg-dark bg-opacity-50 rounded">
									<h4><strong>Formación Técnica</strong></h4>
									<p><strong>Programas técnicos, tecnológicos y cursos cortos.</strong></p>
								</div>
							</a>
						</div>

						<div class="carousel-item">
							<a href="https://betowa.sena.edu.co/" target="_blank">
								<img src="<?php echo sc_url_library('prj', 'Login', 'login/img/imagen3.png') ?>" class="d-block img-fluid mx-auto" alt="imagen 3">
								<div class="carousel-caption d-none d-md-block bg-dark bg-opacity-50 rounded">
									<h4><strong>Innovación y Futuro</strong></h4>
									<p><strong>El SENA impulsa el emprendimiento y la empleabilidad.</strong></p>
								</div>
							</a>
						</div>
					</div>
		...
		<!-- SECCIÓN ESTUDIANTES -->
		<div class="students">
			<h2 class="text-center mb-4"><strong>INFORME REPRESENTATIVO</strong></h2>
			<div class="row g-4">

				<div class="col-12 col-sm-6 col-md-4">
					<div class="student-img text-center">
						<a href="https://ejecucionformacion.sena.edu.co/cursos-cortos" target="_blank">
							<img src="<?php echo sc_url_library('prj', 'Login', 'login/img/captura1.png') ?>" class="img-fluid rounded" alt="imagen 1">
						</a>
					</div>
				</div>
				...
				<div class="col-12 col-sm-6 col-md-4">
					<div class="student-img text-center">
						<a href="https://www.sena.edu.co/es-co/Noticias/Paginas/frecuencia-sena.aspx" target="_blank">
							<img src="<?php echo sc_url_library('prj', 'Login', 'login/img/captura 4.png') ?>" class="img-fluid rounded" alt="imagen 2">
						</a>
					</div>
				</div>
				...
				<div class="col-12 col-sm-6 col-md-4">
					<div class="student-img text-center">
						<a href="https://sava.sena.edu.co/gfvd/" target="_blank">
							<img src="<?php echo sc_url_library('prj', 'Login', 'login/img/captura 5.png') ?>" class="img-fluid rounded" alt="imagen 3">
						</a>
					</div>
				</div>
				...
				<div class="col-12 col-sm-6 col-md-4">
					<div class="student-img text-center">
						<a href="https://caplms.sena.edu.co/" target="_blank">
							<img src="<?php echo sc_url_library('prj', 'Login', 'login/img/captura2.png') ?>" class="img-fluid rounded" alt="imagen 4">
						</a>
					</div>
				</div>
				...
				<div class="col-12 col-sm-6 col-md-4">
					<div class="student-img text-center">
						<a href="https://sava.sena.edu.co/gfvd/" target="_blank">
							<img src="<?php echo sc_url_library('prj', 'Login', 'login/img/captura3.png') ?>" class="img-fluid rounded" alt="imagen 5">
						</a>
					</div>
				</div>
				...
				<div class="col-12 col-sm-6 col-md-4">
					<div class="student-img text-center">
						<a href="https://zajuna.sena.edu.co/Repositorio/Titulada/institution/SENA/Tutoriales/Aprendiz/Manual_LMS_Aprendiz.pdf" target="_blank">
							<img src="<?php echo sc_url_library('prj', 'Login', 'login/img/captura6.png') ?>" class="img-fluid rounded" alt="imagen 6">
						</a>
					</div>
				</div>
		...
		<footer class="bg-light text-center text-lg-start mt-5">
			<div style="background-color:#6c757d; padding:10px; text-align:center;">
				<span class="fw-bold" style="margin-left:40px; color:white;">
					<i class="fa-solid fa-briefcase" style="color:#28a745; margin-right:8px;"></i> <strong>Sector Empleo</strong>
				</span>
			</div>

			<div style="background-color:#003366; padding:15px 0;">
				<div style="display:flex; justify-content:center; align-items:center; gap:50px; flex-wrap:wrap;">
					<a href="https://www.mintrabajo.gov.co/web/guest/inicio" target="_blank">
						<img src="<?php echo sc_url_library('prj', 'Login', 'login/img/gobierno.png') ?>" class="img-fluid rounded" alt="icono 1">
					</a>

					<a href="https://www.unidadsolidaria.gov.co/" target="_blank">
						<img src="<?php echo sc_url_library('prj', 'Login', 'login/img/organizaciones.png') ?>" class="img-fluid rounded" alt="icono 2">
					</a>

					<a href="https://www.serviciodeempleo.gov.co/" target="_blank">
						<img src="<?php echo sc_url_library('prj', 'Login', 'login/img/empleo.png') ?>" class="img-fluid rounded" alt="icono 3">
					</a>

					<a href="https://www.supersubsidio.gov.co/" target="_blank">
						<img src="<?php echo sc_url_library('prj', 'Login', 'login/img/super.png') ?>" class="img-fluid rounded" alt="icono 4">
					</a>

					<a href="https://www.colpensiones.gov.co/" target="_blank">
						<img src="<?php echo sc_url_library('prj', 'Login', 'login/img/col.png') ?>" class="img-fluid rounded" alt="icono 5">
					</a>
				</div>
			</div>

			<div class="container text-center py-4">
				<h6 class="fw-bold"><strong>SERVICIO NACIONAL DE APRENDIZAJE SENA</strong></h6>
				<h6 class="fw-bold">DIRECCIÓN GENERAL</h6>
				<p class="mb-1">Calle 57 No. 8 - 69 Bogotá D.C. (Cundinamarca), Colombia</p>
				<p class="mb-1">El SENA brinda atención presencial en las 33 Regionales y 117 Centros de Formación</p>
				<p class="mb-1">
					<a href="https://www.sena.edu.co/es-co/transparencia/Paginas/mecanismosContacto.aspx" class="text-primary fw-bold">Conozca aquí los puntos de atención</a>
				</p>
				<p class="small">Líneas de atención al ciudadano: Bogotá (+57) 601 736 60 60 - Línea gratuita nacional 018000 910270</p>

				<div class="d-flex justify-content-center align-items-center flex-wrap gap-3 mt-3">
					<img src="https://www.sena.edu.co/Style%20Library/alayout/images/logoSena.png" alt="Logo.png" height="60">
				</div>
			</div>

			<div class="bg-primary text-white text-center py-2">
				<a href="https://www.gov.co/" target="_blank"><strong>gov.co</strong></a>
			</div>
		</footer>
...
<?php
$_SESSION['scriptcase']['Principal']['contr_erro'] = 'off'; 
//--- 
       $this->Db->Close(); 
       if ($this->Change_Menu)
       {
...
//======= =========================
   ...
   if (!empty($_POST))
   {
       foreach ($_POST as $nmgp_var => $nmgp_val)
       {
            ...
            nm_limpa_str_Principal($nmgp_val);
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['Principal']['glo_nm_path_imag_temp'] . "/sc_apl_default_PROYECTO_SENA.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['Principal']['glo_nm_path_imag_temp'] . "/sc_apl_default_PROYECTO_SENA.txt"));
       }
       if (isset($apl_def)) {
           if ($apl_def[0] != "Principal") {
               $_SESSION['scriptcase']['sem_session'] = true;
               if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                   $_SESSION['scriptcase']['Principal']['session_timeout']['redir'] = $apl_def[0];
               }
               else {
                   $_SESSION['scriptcase']['Principal']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
               }
               $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
               $_SESSION['scriptcase']['Principal']['session_timeout']['redir_tp'] = $Redir_tp;
           }
           if (isset($_COOKIE['sc_actual_lang_PROYECTO_SENA'])) {
               $_SESSION['scriptcase']['Principal']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_PROYECTO_SENA'];
           }
       }
   }
   ...
   $salva_iframe = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['Principal']['iframe_menu']))
   {
       $salva_iframe = $_SESSION['sc_session'][$script_case_init]['Principal']['iframe_menu'];
       unset($_SESSION['sc_session'][$script_case_init]['Principal']['iframe_menu']);
   }
   if (isset($nm_run_menu) && $nm_run_menu == 1)
   {
        ...
        $_SESSION['scriptcase']['sc_apl_menu_atual'] = "Principal";
        $achou = false;
        if (isset($_SESSION['sc_session'][$script_case_init]))
        {
            foreach ($_SESSION['sc_session'][$script_case_init] as $nome_apl => $resto)
            {
                if ($nome_apl == 'Principal' || $achou)
                {
        ...
        $_SESSION['sc_session'][$script_case_init]['Principal']['iframe_menu'] = true;
   }
   else
   {
       $_SESSION['sc_session'][$script_case_init]['Principal']['iframe_menu'] = $salva_iframe;
   }

   if (!isset($_SESSION['sc_session'][$script_case_init]['Principal']['initialize']))
   {
       $_SESSION['sc_session'][$script_case_init]['Principal']['initialize'] = true;
   }
   elseif (!isset($_SERVER['HTTP_REFERER']))
   {
       $_SESSION['sc_session'][$script_case_init]['Principal']['initialize'] = false;
   }
   ...
   else
   {
       ...
       if ('Principal' == $sReferer || 'Principal_' == substr($sReferer, 0, 10))
       {
           $_SESSION['sc_session'][$script_case_init]['Principal']['initialize'] = false;
       }
       else
   ...
   if (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'Principal')
   {
       $_SESSION['sc_session'][$script_case_init]['Principal']['sc_outra_jan'] = true;
        unset($_SESSION['scriptcase']['sc_outra_jan']);
   }
   $_SESSION['sc_session'][$script_case_init]['Principal']['menu_desenv'] = false;   
   if (!defined("SC_ERROR_HANDLER"))
   {
       define("SC_ERROR_HANDLER", 1);
       include_once(dirname(__FILE__) . "/Principal_erro.php");
   }
   if (!empty($nmgp_parms)) 
   { 
       ...
       while (!empty($todo[$ix]))
       {
            ...
            if (1 < sizeof($cadapar))
            {
                ...
                nm_limpa_str_Principal($cadapar[1]);
   ...
   $contr_Principal = new Principal_apl();
   $contr_Principal->controle();
//
   function nm_limpa_str_Principal(&$str)
   {
   }
?>

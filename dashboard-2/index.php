<?php
   include_once('dashboard-2_session.php');
   @ini_set('session.cookie_httponly', 1);
   @ini_set('session.use_only_cookies', 1);
   @ini_set('session.cookie_secure', 0);
   @session_start() ;
   $_SESSION['scriptcase']['dashboard-2']['glo_nm_perfil']          = "conn_postgres";
   $_SESSION['scriptcase']['dashboard-2']['glo_nm_path_prod']       = "";
   $_SESSION['scriptcase']['dashboard-2']['glo_nm_path_conf']       = "";
   $_SESSION['scriptcase']['dashboard-2']['glo_nm_path_imagens']    = "";
   $_SESSION['scriptcase']['dashboard-2']['glo_nm_path_imag_temp']  = "";
   $_SESSION['scriptcase']['dashboard-2']['glo_nm_path_cache']      = "";
   $_SESSION['scriptcase']['dashboard-2']['glo_nm_path_doc']        = "";
    ...
    //check prod
    if(empty($_SESSION['scriptcase']['dashboard-2']['glo_nm_path_prod']))
    {
            /*check prod*/$_SESSION['scriptcase']['dashboard-2']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
    }
    //check img
    if(empty($_SESSION['scriptcase']['dashboard-2']['glo_nm_path_imagens']))
    {
            /*check img*/$_SESSION['scriptcase']['dashboard-2']['glo_nm_path_imagens'] = $str_path_apl_url . "_lib/file/img";
    }
    //check tmp
    if(empty($_SESSION['scriptcase']['dashboard-2']['glo_nm_path_imag_temp']))
    {
            /*check tmp*/$_SESSION['scriptcase']['dashboard-2']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
    }
    //check cache
    if(empty($_SESSION['scriptcase']['dashboard-2']['glo_nm_path_cache']))
    {
            /*check tmp*/$_SESSION['scriptcase']['dashboard-2']['glo_nm_path_cache'] = $str_path_apl_dir . "_lib/file/cache";
    }
    //check doc
    if(empty($_SESSION['scriptcase']['dashboard-2']['glo_nm_path_doc']))
    {
            /*check doc*/$_SESSION['scriptcase']['dashboard-2']['glo_nm_path_doc'] = $str_path_apl_dir . "_lib/file/doc";
    }
    //end check publication with the prod
//
class dashboard_2_ini
{
   var $nm_cod_apl;
   var $nm_nome_apl;
   var $nm_seguranca;
...
//
   function init($Tp_init = "")
   {
      ...
      $_SESSION['sc_session'][$this->sc_page]['dashboard-2']['decimal_db'] = "."; 
      $this->nm_cod_apl      = "dashboard-2"; 
      $this->nm_nome_apl     = ""; 
      $this->nm_seguranca    = ""; 
...
// 
      ...
      $this->sc_protocolo    = "";
      $this->path_prod       = $_SESSION['scriptcase']['dashboard-2']['glo_nm_path_prod'];
      $this->path_conf       = $_SESSION['scriptcase']['dashboard-2']['glo_nm_path_conf'];
      $this->path_imagens    = $_SESSION['scriptcase']['dashboard-2']['glo_nm_path_imagens'];
      $this->path_imag_temp  = $_SESSION['scriptcase']['dashboard-2']['glo_nm_path_imag_temp'];
      $this->path_cache  = $_SESSION['scriptcase']['dashboard-2']['glo_nm_path_cache'];
      $this->path_doc        = $_SESSION['scriptcase']['dashboard-2']['glo_nm_path_doc'];
      ...
      if (!isset($_SESSION['scriptcase']['dashboard-2']['save_session']['save_grid_state_session']))
      { 
          $_SESSION['scriptcase']['dashboard-2']['save_session']['save_grid_state_session'] = false;
          $_SESSION['scriptcase']['dashboard-2']['save_session']['data'] = '';
      } 
      $this->str_schema_all    = (isset($_SESSION['scriptcase']['str_schema_all']) && !empty($_SESSION['scriptcase']['str_schema_all'])) ? $_SESSION['scriptcase']['str_schema_all'] : "login/login";
      if (isset($_SESSION['sc_session'][$this->sc_page]['dashboard-2']['sub_cons_schema_all']))
      { 
         $this->str_schema_all    = $_SESSION['sc_session'][$this->sc_page]['dashboard-2']['sub_cons_schema_all'];
         $this->str_schema_filter = $_SESSION['sc_session'][$this->sc_page]['dashboard-2']['sub_cons_schema_filter'];
      } 
      ...
      $this->path_aplicacao  = substr($this->path_aplicacao, 0, strrpos($this->path_aplicacao, '/')) . '/dashboard-2';
      ...
      $_SESSION['sc_session'][$this->sc_page]['dashboard-2']['path_grid_sv'] = $this->root . substr($this->path_prod, 0, $pos_path) . "/conf/grid_sv/";
      ...
      if (isset($_SESSION['scriptcase']['dashboard-2']['session_timeout']['lang'])) {
          $this->str_lang = $_SESSION['scriptcase']['dashboard-2']['session_timeout']['lang'];
      }
      elseif (!isset($_SESSION['scriptcase']['dashboard-2']['actual_lang']) || $_SESSION['scriptcase']['dashboard-2']['actual_lang'] != $this->str_lang) {
          $_SESSION['scriptcase']['dashboard-2']['actual_lang'] = $this->str_lang;
      ...
      {
          include_once("dashboard-2_json.php");
      }
      $this->SC_Link_View = (isset($_SESSION['sc_session'][$this->sc_page]['dashboard-2']['SC_Link_View'])) ? $_SESSION['sc_session'][$this->sc_page]['dashboard-2']['SC_Link_View'] : false;
      if (isset($_GET['SC_Link_View']) && !empty($_GET['SC_Link_View']) && is_numeric($_GET['SC_Link_View']))
      {
          if ($_SESSION['sc_session'][$this->sc_page]['dashboard-2']['embutida'])
          {
              $this->SC_Link_View = true;
              $_SESSION['sc_session'][$this->sc_page]['dashboard-2']['SC_Link_View'] = true;
          }
      }
    ...
    $out1_img_cache = $_SESSION['scriptcase']['dashboard-2']['glo_nm_path_imag_temp'] . $file_name;
    $orig_img = $_SESSION['scriptcase']['dashboard-2']['glo_nm_path_imag_temp']. '/'.basename($_POST['AjaxCheckImg']);
    ...
    if(file_exists($out1_img_cache)){
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['dashboard-2']['ancor_save'] = $_POST['ancor_save'];
...
<?php
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['dashboard-2']['dashboard_info']['under_dashboard']))
      {
          $_SESSION['sc_session'][$this->sc_page]['dashboard-2']['dashboard_info']['under_dashboard'] = false;
          $_SESSION['sc_session'][$this->sc_page]['dashboard-2']['dashboard_info']['dashboard_app']   = '';
          $_SESSION['sc_session'][$this->sc_page]['dashboard-2']['dashboard_info']['own_widget']      = '';
          $_SESSION['sc_session'][$this->sc_page]['dashboard-2']['dashboard_info']['parent_widget']   = '';
          $_SESSION['sc_session'][$this->sc_page]['dashboard-2']['dashboard_info']['compact_mode']    = false;
          $_SESSION['sc_session'][$this->sc_page]['dashboard-2']['dashboard_info']['remove_margin']   = false;
          $_SESSION['sc_session'][$this->sc_page]['dashboard-2']['dashboard_info']['remove_border']   = false;
      }
      if (isset($_GET['under_dashboard']) && 1 == $_GET['under_dashboard'])
      {
          if (isset($_GET['own_widget']) && 'dbifrm_widget' == substr($_GET['own_widget'], 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['dashboard-2']['dashboard_info']['own_widget'] = $_GET['own_widget'];
              $_SESSION['sc_session'][$this->sc_page]['dashboard-2']['dashboard_info']['under_dashboard'] = true;
              if (isset($_GET['dashboard_app'])) {
                  $_SESSION['sc_session'][$this->sc_page]['dashboard-2']['dashboard_info']['dashboard_app'] = $_GET['dashboard_app'];
              }
              if (isset($_GET['parent_widget'])) {
                  $_SESSION['sc_session'][$this->sc_page]['dashboard-2']['dashboard_info']['parent_widget'] = $_GET['parent_widget'];
              }
              if (isset($_GET['compact_mode'])) {
                  $_SESSION['sc_session'][$this->sc_page]['dashboard-2']['dashboard_info']['compact_mode'] = 1 == $_GET['compact_mode'];
              }
              if (isset($_GET['remove_margin'])) {
                  $_SESSION['sc_session'][$this->sc_page]['dashboard-2']['dashboard_info']['remove_margin'] = 1 == $_GET['remove_margin'];
              }
              if (isset($_GET['remove_border'])) {
                  $_SESSION['sc_session'][$this->sc_page]['dashboard-2']['dashboard_info']['remove_border'] = 1 == $_GET['remove_border'];
              }
          }
      }
      elseif (isset($under_dashboard) && 1 == $under_dashboard)
      {
          if (isset($own_widget) && 'dbifrm_widget' == substr($own_widget, 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['dashboard-2']['dashboard_info']['own_widget'] = $own_widget;
              $_SESSION['sc_session'][$this->sc_page]['dashboard-2']['dashboard_info']['under_dashboard'] = true;
              if (isset($dashboard_app)) {
                  $_SESSION['sc_session'][$this->sc_page]['dashboard-2']['dashboard_info']['dashboard_app'] = $dashboard_app;
              }
              if (isset($parent_widget)) {
                  $_SESSION['sc_session'][$this->sc_page]['dashboard-2']['dashboard_info']['parent_widget'] = $parent_widget;
              }
              if (isset($compact_mode)) {
                  $_SESSION['sc_session'][$this->sc_page]['dashboard-2']['dashboard_info']['compact_mode'] = 1 == $compact_mode;
              }
              if (isset($remove_margin)) {
                  $_SESSION['sc_session'][$this->sc_page]['dashboard-2']['dashboard_info']['remove_margin'] = 1 == $remove_margin;
              }
              if (isset($remove_border)) {
                  $_SESSION['sc_session'][$this->sc_page]['dashboard-2']['dashboard_info']['remove_border'] = 1 == $remove_border;
              }
          }
      }
      if (!isset($_SESSION['sc_session'][$this->sc_page]['dashboard-2']['dashboard_info']['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['dashboard-2']['dashboard_info']['maximized'] = false;
      }
      if (isset($_GET['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['dashboard-2']['dashboard_info']['maximized'] = 1 == $_GET['maximized'];
      }
      if ($_SESSION['sc_session'][$this->sc_page]['dashboard-2']['dashboard_info']['under_dashboard'])
      {
          $sTmpDashboardApp = $_SESSION['sc_session'][$this->sc_page]['dashboard-2']['dashboard_info']['dashboard_app'];
          if ('' != $sTmpDashboardApp && isset($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["dashboard-2"]))
          {
              foreach ($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["dashboard-2"] as $sTmpTargetLink => $sTmpTargetWidget)
              {
        ...
        if (isset($link_compact_mode) && 'ok' == $link_compact_mode) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['dashboard-2']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['dashboard-2']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['dashboard-2']['link_info']['compact_mode'] = true;
        }
        if (isset($link_remove_margin) && 'ok' == $link_remove_margin) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['dashboard-2']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['dashboard-2']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['dashboard-2']['link_info']['remove_margin'] = true;
        }
        if (isset($link_remove_border) && 'ok' == $link_remove_border) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['dashboard-2']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['dashboard-2']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['dashboard-2']['link_info']['remove_border'] = true;
        }

      if (!isset($_SESSION['sc_session'][$this->sc_page]['dashboard-2']['responsive_chart']))
      {
          $_SESSION['sc_session'][$this->sc_page]['dashboard-2']['responsive_chart'] = array(
              'enabled' => false,
              'active'  => false,
          );
      }
      if ($_SESSION['sc_session'][$this->sc_page]['dashboard-2']['responsive_chart']['enabled'])
      {
          $_SESSION['sc_session'][$this->sc_page]['dashboard-2']['responsive_chart']['active'] = true;
      }
      elseif ($_SESSION['sc_session'][$this->sc_page]['dashboard-2']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->sc_page]['dashboard-2']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->sc_page]['dashboard-2']['dashboard_info']['maximized'])
      {
          $_SESSION['sc_session'][$this->sc_page]['dashboard-2']['responsive_chart']['active'] = true;
      }
      else
      {
          $_SESSION['sc_session'][$this->sc_page]['dashboard-2']['responsive_chart']['active'] = false;
      }
      if ($Tp_init == "Path_sub")
      {
          return;
      ...
      if (!is_file($this->root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
      {
          ...
          unset($_SESSION['scriptcase']['dashboard-2']['glo_nm_conexao']);
      }
      ...
      if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['dashboard-2']['session_timeout']['redir']))
      {
      ...
      $_SESSION['sc_session'][$this->sc_page]['dashboard-2']['path_doc'] = $this->path_doc; 
      ...
      if (!is_dir($this->root . $this->path_prod))
      {
          ...
          echo " </tr>";
          echo "</table>";
          if (!$_SESSION['sc_session'][$script_case_init]['dashboard-2']['iframe_menu'] && (!isset($_SESSION['sc_session'][$script_case_init]['dashboard-2']['sc_outra_jan']) || !$_SESSION['sc_session'][$script_case_init]['dashboard-2']['sc_outra_jan'])) 
          { 
...
// 
      include_once($this->path_aplicacao . "dashboard-2_erro.class.php"); 
      $this->Erro = new dashboard_2_erro();
      include_once($this->path_adodb . "/adodb.inc.php"); 
      $this->sc_Include($this->path_libs . "/nm_sec_prod.php", "F", "nm_reg_prod") ; 
      $this->sc_Include($this->path_libs . "/nm_ini_perfil.php", "F", "perfil_lib") ; 
// 
 if(function_exists('set_php_timezone')) set_php_timezone('dashboard-2'); 
// 
      ...
      if (isset($_SESSION['scriptcase']['dashboard-2']['session_timeout']['redir'])) {
          ...
          if ($_SESSION['scriptcase']['dashboard-2']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "  </HEAD>\r\n";
              $SS_cod_html .= "   <body>\r\n";
          }
          else {
              ...
              $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['dashboard-2']['session_timeout']['redir'] . "');\">\r\n";
              $SS_cod_html .= "     </form>\r\n";
          ...
          if ($_SESSION['scriptcase']['dashboard-2']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['dashboard-2']['session_timeout']['redir'] . "');\r\n";
          }
          ...
          $SS_cod_html .= " </body>\r\n";
          $SS_cod_html .= "</HTML>\r\n";
          unset($_SESSION['scriptcase']['dashboard-2']['session_timeout']);
          unset($_SESSION['sc_session']);
      }
      ...
      $_SESSION['sc_session'][$this->sc_page]['dashboard-2']['seq_dir'] = 0; 
      $_SESSION['sc_session'][$this->sc_page]['dashboard-2']['sub_dir'] = array(); 
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
      $this->conectDB();
   ...
   function prep_conect()
   {
      if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
      {
          ...
          {
              if (isset($_SESSION['scriptcase']['dashboard-2']['glo_nm_conexao']) && $_SESSION['scriptcase']['dashboard-2']['glo_nm_conexao'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['dashboard-2']['glo_nm_conexao'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['dashboard-2']['glo_nm_perfil']) && $_SESSION['scriptcase']['dashboard-2']['glo_nm_perfil'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['dashboard-2']['glo_nm_perfil'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['dashboard-2']['glo_con_' . $NM_con_orig]))
              {
                  $_SESSION['scriptcase']['dashboard-2']['glo_con_' . $NM_con_orig] = $NM_con_dest;
              }
          }
      }
      $con_devel             = (isset($_SESSION['scriptcase']['dashboard-2']['glo_nm_conexao'])) ? $_SESSION['scriptcase']['dashboard-2']['glo_nm_conexao'] : ""; 
      $perfil_trab           = ""; 
      $this->nm_falta_var    = ""; 
      $this->nm_falta_var_db = ""; 
      $nm_crit_perfil        = false;
      if (isset($_SESSION['scriptcase']['dashboard-2']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['dashboard-2']['glo_nm_conexao']))
      {
      ...
      if (isset($_SESSION['scriptcase']['dashboard-2']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['dashboard-2']['glo_nm_perfil']))
      {
          $perfil_trab = $_SESSION['scriptcase']['dashboard-2']['glo_nm_perfil'];
      }
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['dashboard-2']['embutida_init']) || !$_SESSION['sc_session'][$this->sc_page]['dashboard-2']['embutida_init']) 
      {
      }
// 
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['dashboard-2']['decimal_db'] = $_SESSION['scriptcase']['glo_decimal_db']; 
      }
      if (isset($_SESSION['scriptcase']['glo_date_separator']) && !empty($_SESSION['scriptcase']['glo_date_separator']))
      {
          ...
          if (strlen($SC_temp) == 2)
          {
              $_SESSION['sc_session'][$this->sc_page]['dashboard-2']['SC_sep_date']  = substr($SC_temp, 0, 1); 
              $_SESSION['sc_session'][$this->sc_page]['dashboard-2']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
          }
          else
           {
              $_SESSION['sc_session'][$this->sc_page]['dashboard-2']['SC_sep_date']  = $SC_temp; 
              $_SESSION['sc_session'][$this->sc_page]['dashboard-2']['SC_sep_date1'] = $SC_temp; 
          }
          $this->date_delim  = $_SESSION['sc_session'][$this->sc_page]['dashboard-2']['SC_sep_date'];
          $this->date_delim1 = $_SESSION['sc_session'][$this->sc_page]['dashboard-2']['SC_sep_date1'];
      }
// 
...
<?php
   ...
   function conectDB()
   {
      ...
      if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['dashboard-2']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['dashboard-2']['glo_nm_conexao']))
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['dashboard-2']['glo_nm_conexao'], $this->root . $this->path_prod, 'PROYECTO_SENA', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['dashboard-2']['embutida']) || !$_SESSION['sc_session'][$this->sc_page]['dashboard-2']['embutida'])
      {
...
// 
   ...
   function sc_Sql_Protect($var, $tp, $conex="")
   {
       ...
       if ($tp == "date")
       {
           ...
           if (isset($_SESSION['sc_session'][$this->sc_page]['dashboard-2']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->sc_page]['dashboard-2']['SC_sep_date']))
           {
               $delim  = $_SESSION['sc_session'][$this->sc_page]['dashboard-2']['SC_sep_date'];
               $delim1 = $_SESSION['sc_session'][$this->sc_page]['dashboard-2']['SC_sep_date1'];
           }
   ...
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['dashboard-2']['SC_Gb_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['dashboard-2']['SC_Gb_date_format'][$GB][$cmp] : "";
   }

   function Get_Gb_prefix_date_format($GB, $cmp)
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['dashboard-2']['SC_Gb_prefix_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['dashboard-2']['SC_Gb_prefix_date_format'][$GB][$cmp] : "";
   }
...
//----- 
   function controle()
   {
      ...
      $this->Ini = new dashboard_2_ini(); 
      $this->Ini->init();
      $this->Change_Menu = false;
      if (isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard-2']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['dashboard-2']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['dashboard-2']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['dashboard-2'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['dashboard-2']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['dashboard-2']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('dashboard-2') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['dashboard-2']['label'] = "" . $this->Ini->Nm_lang['lang_othr_blank_title'] . "";
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['dashboard-2']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['dashboard-2']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['dashboard-2']['exit'];
      ...
      $this->Db = $this->Ini->Db; 
      include_once($this->Ini->path_aplicacao . "dashboard-2_erro.class.php"); 
      $this->Erro      = new dashboard_2_erro();
      $this->Erro->Ini = $this->Ini;
//
      header("X-XSS-Protection: 1; mode=block");
      header("X-Frame-Options: SAMEORIGIN");
      $_SESSION['scriptcase']['dashboard-2']['contr_erro'] = 'on';
...
"; 
      ...
      if ($this->ds_cursos = $this->Db->Execute($nm_select)) 
      { }
      elseif (isset($GLOBALS["NM_ERRO_IBASE"]) && $GLOBALS["NM_ERRO_IBASE"] != 1)  
      { 
          $this->ds_cursos = false;
          $this->ds_cursos_erro = $this->Db->ErrorMsg();
      } 
...
if ($this->ds_cursos !== false) {
	while (!$this->ds_cursos->EOF) {
		$labels[] = $this->ds_cursos->fields[0];   
		$values[] = $this->ds_cursos->fields[1];   
		$this->ds_cursos->MoveNext();
	}
}

 
      $nm_select = "
    SELECT COUNT(*) AS total_aspirantes_activos
    FROM aspirantes
    WHERE activo = true
"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($this->ds_aspirantes_a = $this->Db->Execute($nm_select)) 
      { }
      elseif (isset($GLOBALS["NM_ERRO_IBASE"]) && $GLOBALS["NM_ERRO_IBASE"] != 1)  
      { 
          $this->ds_aspirantes_a = false;
          $this->ds_aspirantes_a_erro = $this->Db->ErrorMsg();
      } 


if (false !== $this->ds_aspirantes_a) {
	$total_aspirantes = $this->ds_aspirantes_a->fields[0];
}
...
WHERE activo = true;"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($this->ds_total_cursos = $this->Db->Execute($nm_select)) 
      { }
      elseif (isset($GLOBALS["NM_ERRO_IBASE"]) && $GLOBALS["NM_ERRO_IBASE"] != 1)  
      { 
          $this->ds_total_cursos = false;
          $this->ds_total_cursos_erro = $this->Db->ErrorMsg();
      } 


if($this->ds_total_cursos !== false){
	$total_cursos =	$this->ds_total_cursos->fields[0];
}
...
"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($this->ds_inscripcion = $this->Db->Execute($nm_select)) 
      { }
      elseif (isset($GLOBALS["NM_ERRO_IBASE"]) && $GLOBALS["NM_ERRO_IBASE"] != 1)  
      { 
          $this->ds_inscripcion = false;
          $this->ds_inscripcion_erro = $this->Db->ErrorMsg();
      } 


if($this->ds_inscripcion !== false){
	$total_inscripciones =	$this->ds_inscripcion->fields[0];
}
...
"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($this->ds_cursos_a = $this->Db->Execute($nm_select)) 
      { }
      elseif (isset($GLOBALS["NM_ERRO_IBASE"]) && $GLOBALS["NM_ERRO_IBASE"] != 1)  
      { 
          $this->ds_cursos_a = false;
          $this->ds_cursos_a_erro = $this->Db->ErrorMsg();
      } 
...
if ($this->ds_cursos_a !== false) {
	while (!$this->ds_cursos_a->EOF) {
		$labels_curso[] = $this->ds_cursos_a->fields[0];   
		$values_curso[] = $this->ds_cursos_a->fields[1];   
		$this->ds_cursos_a->MoveNext();
...
$labels_cursos_js = json_encode($labels_curso);
$values_cursos_js = json_encode($values_curso);
...
<style>
	...
	.bg-white p-2 rounded-2xl shadow-lg{
...
<html lang="es">
	...
	<body class="bg-gray-100 p-6">
		...
		<div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
			<div class="bg-purple-500 text-white p-4 rounded-2xl shadow-lg text-center">
				<p class="text-xl">Aspirantes</p>
				<h2 class="text-3xl font-bold"><?php echo $total_aspirantes ?></h2>
			</div>
			<div class="bg-green-500 text-white p-4 rounded-2xl shadow-lg text-center">
				<p class="text-xl">Cursos Activos</p>
				<h2 class="text-3xl font-bold"><?php echo $total_cursos ?></h2>
			</div>
			<div class="bg-blue-500 text-white p-4 rounded-2xl shadow-lg text-center">
				<p class="text-xl">Inscripciones</p>
				<h2 class="text-3xl font-bold"><?php echo $total_inscripciones ?></h2>
			</div>
		</div> <!-- ✅ cierre correcto de tarjetas -->

		<!-- Reportes -->
		<div class="grid grid-cols-1 md:grid-cols-2 gap-6">
			<!-- Donut -->
			<div class="bg-white p-2 rounded-2xl shadow-lg">
				<h3 class="text-lg font-bold mb-4">Estado del Curso</h3>
				<canvas id="donutChart"></canvas>
			</div>

			<!-- Línea -->
			<div class="bg-white p-2 rounded-2xl shadow-lg">
				<h3 class="text-lg font-bold mb-4">Aspirantes por Curso</h3>
	...
	const values = <?php echo $values_json; ?>;
	const cursos_label = <?php echo $labels_cursos_js; ?>;
	const cursos_values = <?php echo $values_cursos_js; ?>;
	...
	new Chart(ctx, {
		...
		options: {
			...
			scales: {
				y: {
					beginAtZero: true,
					title: { display: true, text: 'Cantidad de Aspirantes', color: '#333' },
					grid: { color: '#E5E7EB' },
					ticks: { stepSize: 1, color: '#111' }
				},
				x: {
					title: { display: true, text: 'Cursos', color: '#333' },
					grid: { display: false },
					ticks: { color: '#111', autoSkip: false, maxRotation: 45, minRotation: 0 }
				}
			},
			plugins: {
				...
				tooltip: {
					...
					padding: 10,
					callbacks: {
						label: (context) => ` $$context_raw  aspirantes`
					}
				}
			}
		}
	...
	<?php
$_SESSION['scriptcase']['dashboard-2']['contr_erro'] = 'off'; 
//--- 
       $this->Db->Close(); 
       if ($this->Change_Menu)
       {
...
//======= =========================
   ...
   if (!empty($_POST))
   {
       foreach ($_POST as $nmgp_var => $nmgp_val)
       {
            ...
            nm_limpa_str_dashboard_2($nmgp_val);
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['dashboard-2']['glo_nm_path_imag_temp'] . "/sc_apl_default_PROYECTO_SENA.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['dashboard-2']['glo_nm_path_imag_temp'] . "/sc_apl_default_PROYECTO_SENA.txt"));
       }
       if (isset($apl_def)) {
           if ($apl_def[0] != "dashboard-2") {
               $_SESSION['scriptcase']['sem_session'] = true;
               if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                   $_SESSION['scriptcase']['dashboard-2']['session_timeout']['redir'] = $apl_def[0];
               }
               else {
                   $_SESSION['scriptcase']['dashboard-2']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
               }
               $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
               $_SESSION['scriptcase']['dashboard-2']['session_timeout']['redir_tp'] = $Redir_tp;
           }
           if (isset($_COOKIE['sc_actual_lang_PROYECTO_SENA'])) {
               $_SESSION['scriptcase']['dashboard-2']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_PROYECTO_SENA'];
           }
       }
   }
   ...
   $salva_iframe = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['dashboard-2']['iframe_menu']))
   {
       $salva_iframe = $_SESSION['sc_session'][$script_case_init]['dashboard-2']['iframe_menu'];
       unset($_SESSION['sc_session'][$script_case_init]['dashboard-2']['iframe_menu']);
   }
   if (isset($nm_run_menu) && $nm_run_menu == 1)
   {
        ...
        $_SESSION['scriptcase']['sc_apl_menu_atual'] = "dashboard-2";
        $achou = false;
        if (isset($_SESSION['sc_session'][$script_case_init]))
        {
            foreach ($_SESSION['sc_session'][$script_case_init] as $nome_apl => $resto)
            {
                if ($nome_apl == 'dashboard-2' || $achou)
                {
        ...
        $_SESSION['sc_session'][$script_case_init]['dashboard-2']['iframe_menu'] = true;
   }
   else
   {
       $_SESSION['sc_session'][$script_case_init]['dashboard-2']['iframe_menu'] = $salva_iframe;
   }

   if (!isset($_SESSION['sc_session'][$script_case_init]['dashboard-2']['initialize']))
   {
       $_SESSION['sc_session'][$script_case_init]['dashboard-2']['initialize'] = true;
   }
   elseif (!isset($_SERVER['HTTP_REFERER']))
   {
       $_SESSION['sc_session'][$script_case_init]['dashboard-2']['initialize'] = false;
   }
   ...
   else
   {
       ...
       if ('dashboard-2' == $sReferer || 'dashboard-2_' == substr($sReferer, 0, 12))
       {
           $_SESSION['sc_session'][$script_case_init]['dashboard-2']['initialize'] = false;
       }
       else
   ...
   if (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'dashboard-2')
   {
       $_SESSION['sc_session'][$script_case_init]['dashboard-2']['sc_outra_jan'] = true;
        unset($_SESSION['scriptcase']['sc_outra_jan']);
   }
   $_SESSION['sc_session'][$script_case_init]['dashboard-2']['menu_desenv'] = false;   
   if (!defined("SC_ERROR_HANDLER"))
   {
       define("SC_ERROR_HANDLER", 1);
       include_once(dirname(__FILE__) . "/dashboard-2_erro.php");
   }
   if (!empty($nmgp_parms)) 
   { 
       ...
       while (!empty($todo[$ix]))
       {
            ...
            if (1 < sizeof($cadapar))
            {
                ...
                nm_limpa_str_dashboard_2($cadapar[1]);
   ...
   $contr_dashboard_2 = new dashboard_2_apl();
   $contr_dashboard_2->controle();
//
   function nm_limpa_str_dashboard_2(&$str)
   {
   }
?>

<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_public_cursos']['glo_nm_path_imag_temp'] . "/sc_apl_default_PROYECTO_SENA.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_public_cursos_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_public_cursos_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_public_cursos']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_public_cursos']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels     = array();
   $tab_ger_campos['c_nombre_curso'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['c_nombre_curso'] = "c_nombre_curso";
   }
   else
   {
       $tab_def_campos['c_nombre_curso'] = "c.nombre_curso";
   }
   $tab_labels["c_nombre_curso"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_public_cursos']['labels']["c_nombre_curso"])) ? $_SESSION['sc_session'][$sc_init]['grid_public_cursos']['labels']["c_nombre_curso"] : "Nombre Curso";
   $tab_ger_campos['modalidad'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['modalidad'] = "modalidad";
   }
   else
   {
       $tab_def_campos['modalidad'] = "m.descripcion";
   }
   $tab_labels["modalidad"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_public_cursos']['labels']["modalidad"])) ? $_SESSION['sc_session'][$sc_init]['grid_public_cursos']['labels']["modalidad"] : "Modalidad";
   $tab_ger_campos['c_intensidad_horas'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['c_intensidad_horas'] = "c_intensidad_horas";
   }
   else
   {
       $tab_def_campos['c_intensidad_horas'] = "c.intensidad_horas";
   }
   $tab_labels["c_intensidad_horas"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_public_cursos']['labels']["c_intensidad_horas"])) ? $_SESSION['sc_session'][$sc_init]['grid_public_cursos']['labels']["c_intensidad_horas"] : "Intensidad Horas";
   $tab_ger_campos['c_cupo_maximo'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['c_cupo_maximo'] = "c_cupo_maximo";
   }
   else
   {
       $tab_def_campos['c_cupo_maximo'] = "c.cupo_maximo";
   }
   $tab_labels["c_cupo_maximo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_public_cursos']['labels']["c_cupo_maximo"])) ? $_SESSION['sc_session'][$sc_init]['grid_public_cursos']['labels']["c_cupo_maximo"] : "Cupo Maximo";
   $tab_ger_campos['cupos_disponibles'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['cupos_disponibles'] = "cupos_disponibles";
   }
   else
   {
       $tab_def_campos['cupos_disponibles'] = "(c.cupo_maximo - COALESCE(COUNT(i.id),0))";
   }
   $tab_labels["cupos_disponibles"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_public_cursos']['labels']["cupos_disponibles"])) ? $_SESSION['sc_session'][$sc_init]['grid_public_cursos']['labels']["cupos_disponibles"] : "Cupos Disponibles";
   $tab_ger_campos['c_horario'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['c_horario'] = "c_horario";
   }
   else
   {
       $tab_def_campos['c_horario'] = "c.horario";
   }
   $tab_labels["c_horario"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_public_cursos']['labels']["c_horario"])) ? $_SESSION['sc_session'][$sc_init]['grid_public_cursos']['labels']["c_horario"] : "Horario";
   ...
   {
       $tab_def_campos['nivel'] = "n.descripcion";
   }
   $tab_labels["nivel"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_public_cursos']['labels']["nivel"])) ? $_SESSION['sc_session'][$sc_init]['grid_public_cursos']['labels']["nivel"] : "Nivel";
   ...
   $tab_labels["estado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_public_cursos']['labels']["estado"])) ? $_SESSION['sc_session'][$sc_init]['grid_public_cursos']['labels']["estado"] : "Estado";
   ...
   {
       $tab_def_campos['sc_field_0'] = "c.año";
   }
   $tab_labels["sc_field_0"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_public_cursos']['labels']["sc_field_0"])) ? $_SESSION['sc_session'][$sc_init]['grid_public_cursos']['labels']["sc_field_0"] : "año";
   $tab_ger_campos['c_fecha_inicio'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['c_fecha_inicio'] = "c_fecha_inicio";
   }
   else
   {
       $tab_def_campos['c_fecha_inicio'] = "c.fecha_inicio";
   }
   $tab_labels["c_fecha_inicio"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_public_cursos']['labels']["c_fecha_inicio"])) ? $_SESSION['sc_session'][$sc_init]['grid_public_cursos']['labels']["c_fecha_inicio"] : "Fecha Inicio";
   $tab_ger_campos['c_fecha_fin'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['c_fecha_fin'] = "c_fecha_fin";
   }
   else
   {
       $tab_def_campos['c_fecha_fin'] = "c.fecha_fin";
   }
   $tab_labels["c_fecha_fin"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_public_cursos']['labels']["c_fecha_fin"])) ? $_SESSION['sc_session'][$sc_init]['grid_public_cursos']['labels']["c_fecha_fin"] : "Fecha Fin";
   $tab_ger_campos['c_created_at'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['c_created_at'] = "c_created_at";
   }
   else
   {
       $tab_def_campos['c_created_at'] = "c.created_at";
   }
   $tab_labels["c_created_at"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_public_cursos']['labels']["c_created_at"])) ? $_SESSION['sc_session'][$sc_init]['grid_public_cursos']['labels']["c_created_at"] : "Created At";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_public_cursos']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_public_cursos']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_public_cursos']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_public_cursos']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_public_cursos']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_public_cursos']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_public_cursos']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_public_cursos']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_public_cursos']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_public_cursos']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_public_cursos']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_public_cursos']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_public_cursos_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_public_cursos']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_public_cursos']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_public_cursos']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_public_cursos']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_public_cursos']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {

<?php
@session_start() ;
$_SESSION['scriptcase']['grid_public_cursos']['sc_process_barr'] = true;
require_once('../grid_public_cursos/index.php');
unset($_SESSION['scriptcase']['grid_public_cursos']['sc_process_barr']);
$ExportCtrl = new grid_public_cursos_export_control;
$ExportCtrl->Export_barr();

class grid_public_cursos_export_control
{

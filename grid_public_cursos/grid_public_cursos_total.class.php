...
class grid_public_cursos_total
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function __construct($sc_page)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['grid_public_cursos']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['grid_public_cursos']['campos_busca']))
      { 
   ...
   {
      global $nada, $nm_lang ;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_cursos']['contr_total_geral'] == "OK") 
      { 
          return; 
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_cursos']['tot_geral'] = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
          $nm_comando = "select count(*) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_cursos']['where_pesq']; 
      } 
      ...
      $nm_comando .= " group by c.id,      c.nombre_curso,     c.descripcion,     c.intensidad_horas,     c.año,     n.descripcion,     c.horario,     c.cupo_maximo,     c.activo,     c.fecha_inicio,     c.fecha_fin,     m.descripcion,     c.created_at"; 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_cursos']['tot_geral'][0] = "" . $this->Ini->Nm_lang['lang_msgs_totl'] . ""; 
      while (!$rt->EOF) 
      {
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_cursos']['tot_geral'][1])) 
         {
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_cursos']['tot_geral'][1] = 1 ; 
         } 
         else
         {
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_cursos']['tot_geral'][1] += 1 ; 
      ...
      $rt->Close(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_cursos']['contr_total_geral'] = "OK";
   } 

...
function actionBar_getStateHide($buttonName)
{
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          if (!is_file($this->Ini->root . $this->Ini->path_link . "grid_public_cursos/grid_public_cursos_res_xls.class.php"))
          {
              $this->Tem_xls_res  = false;
          }
          if ($this->Tem_xls_res)
          { 
              require_once($this->Ini->path_aplicacao . "grid_public_cursos_res_xls.class.php");
              $this->Res_xls = new grid_public_cursos_res_xls();
              $this->prep_modulos("Res_xls");
          } 
          $this->Arquivo    = "sc_xls";
          $this->Arquivo   .= "_" . date("YmdHis") . "_" . rand(0, 1000);
          $this->Arq_zip    = $this->Arquivo . "_grid_public_cursos.zip";
          $this->Arquivo   .= "_grid_public_cursos" . $this->Xls_tp;
          $this->Tit_doc    = "grid_public_cursos" . $this->Xls_tp;
          $this->Tit_zip    = "grid_public_cursos.zip";
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_cursos']['embutida'] && !$this->Ini->sc_export_ajax) {
          ...
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_cursos']['xls_return']);
          if ($this->Tem_xls_res) {
   ...
   function grava_arquivo()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_cursos']['field_order'] as $Cada_cmp)
      {
...
$_SESSION['scriptcase']['grid_public_cursos']['contr_erro'] = 'off'; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_cursos']['xls_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_cursos']['xls_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_cursos']['xls_name'] .= $this->Xls_tp;
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_cursos']['xls_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_cursos']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_cursos']['xls_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_cursos']['xls_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_cursos']['xls_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_cursos']['xls_name']);
          $this->Xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
          $this->Zip_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arq_zip;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_cursos']['embutida_label']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_cursos']['embutida_label'])
      { 
          $this->count_span = 0;
          $this->Xls_row++;
          $this->proc_label();
    ...
    END as estado, c.año as sc_field_0, c.fecha_inicio as c_fecha_inicio, c.fecha_fin as c_fecha_fin, c.created_at as c_created_at, c.id as c_id from " . $this->Ini->nm_tabela; 
     ...
     $nm_houve_quebra = "N";
         ...
         if (isset($this->NM_Row_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_cursos']['embutida'])
         { 
      ...
      $this->xls_set_style();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_cursos']['embutida'] && $prim_reg)
      { 
          $this->proc_label();
          $this->xls_sub_cons_copy_label($this->Xls_row);
      ...
      if (isset($this->NM_Col_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_cursos']['embutida'])
      { 
      ...
      { 
          if ($this->Tem_xls_res)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_cursos']['xls_res_grid'] = true;
              if (!$this->Ini->sc_export_ajax) {
              ...
              if ($this->Use_phpspreadsheet) {
                  $Xls_res = \PhpOffice\PhpSpreadsheet\IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_cursos']['xls_res_sheet']);
              }
              else {
                  $Xls_res = PHPExcel_IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_cursos']['xls_res_sheet']);
              }
              foreach($Xls_res->getAllSheets() as $sheet)
              {
                  $this->Xls_dados->addExternalSheet($sheet);
              }
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_cursos']['xls_res_grid']);
              unlink($_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_cursos']['xls_res_sheet']);
          } 
          if (!$this->Ini->sc_export_ajax) {
   ...
   function NM_export_modalidad()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->modalidad, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->modalidad, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- c_intensidad_horas
   function NM_export_c_intensidad_horas()
   {
         ...
         if (is_numeric($this->c_intensidad_horas))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->c_intensidad_horas);
         $this->Xls_col++;
   }
   //----- c_cupo_maximo
   function NM_export_c_cupo_maximo()
   {
         ...
         if (is_numeric($this->c_cupo_maximo))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->c_cupo_maximo);
         $this->Xls_col++;
   }
   //----- cupos_disponibles
   function NM_export_cupos_disponibles()
   {
         ...
         if (is_numeric($this->cupos_disponibles))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->cupos_disponibles);
         $this->Xls_col++;
   }
   //----- c_horario
   function NM_export_c_horario()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->c_horario, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->c_horario, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- nivel
   ...
   function NM_export_c_fecha_inicio()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->c_fecha_inicio = substr($this->c_fecha_inicio, 0, 10);
         if (empty($this->c_fecha_inicio) || $this->c_fecha_inicio == "0000-00-00")
         {
             if ($this->Use_phpspreadsheet) {
                 $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->c_fecha_inicio, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
             }
             else {
                 $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->c_fecha_inicio, PHPExcel_Cell_DataType::TYPE_STRING);
             }
         }
         else
         {
             $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->c_fecha_inicio);
   ...
   function NM_export_c_fecha_fin()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->c_fecha_fin = substr($this->c_fecha_fin, 0, 10);
         if (empty($this->c_fecha_fin) || $this->c_fecha_fin == "0000-00-00")
         {
             if ($this->Use_phpspreadsheet) {
                 $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->c_fecha_fin, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
             }
             else {
                 $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->c_fecha_fin, PHPExcel_Cell_DataType::TYPE_STRING);
             }
         }
         else
         {
             $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->c_fecha_fin);
             $this->NM_ctrl_style[$current_cell_ref]['format'] = $this->SC_date_conf_region;
         }
         $this->Xls_col++;
   }
   ...
   function NM_export_c_created_at()
   {
      ...
      if (!empty($this->c_created_at))
      {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->c_created_at, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->c_created_at, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- c_nombre_curso
   ...
   //----- modalidad
   function NM_sub_cons_modalidad()
   {
         $this->modalidad = html_entity_decode($this->modalidad, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->modalidad = strip_tags($this->modalidad);
         $this->modalidad = NM_charset_to_utf8($this->modalidad);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->modalidad;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- c_intensidad_horas
   function NM_sub_cons_c_intensidad_horas()
   {
         $this->c_intensidad_horas = NM_charset_to_utf8($this->c_intensidad_horas);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->c_intensidad_horas;
   ...
   //----- c_cupo_maximo
   function NM_sub_cons_c_cupo_maximo()
   {
         $this->c_cupo_maximo = NM_charset_to_utf8($this->c_cupo_maximo);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->c_cupo_maximo;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "center";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- cupos_disponibles
   function NM_sub_cons_cupos_disponibles()
   {
         $this->cupos_disponibles = NM_charset_to_utf8($this->cupos_disponibles);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->cupos_disponibles;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "center";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- c_horario
   function NM_sub_cons_c_horario()
   {
         $this->c_horario = html_entity_decode($this->c_horario, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->c_horario = strip_tags($this->c_horario);
         $this->c_horario = NM_charset_to_utf8($this->c_horario);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->c_horario;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "center";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- c_fecha_inicio
   function NM_sub_cons_c_fecha_inicio()
   {
         $this->c_fecha_inicio = substr($this->c_fecha_inicio, 0, 10);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->c_fecha_inicio;
   ...
   //----- c_fecha_fin
   function NM_sub_cons_c_fecha_fin()
   {
         $this->c_fecha_fin = substr($this->c_fecha_fin, 0, 10);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->c_fecha_fin;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "data";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "center";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = $this->SC_date_conf_region;
         $this->Xls_col++;
   ...
   //----- c_created_at
   function NM_sub_cons_c_created_at()
   {
      if (!empty($this->c_created_at))
      {
         if (substr($this->c_created_at, 10, 1) == "-") 
         ...
         $this->c_created_at = NM_charset_to_utf8($this->c_created_at);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->c_created_at;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "center";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_cursos']['nolabel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_cursos']['nolabel'])
       {
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_cursos']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_cursos']['xls_file'] = $this->Xls_f;
      }
...
<HEAD>
 <TITLE>REGISTRO DE CURSOS :: Excel</TITLE>
...
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_cursos']['xls_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php

...
$this->tab_grupo[0] = "PROYECTO_SENA/";
if ($_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] != "S")
{
    $this->tab_grupo[0] = "";
}
...
<style>
	.scMenuHHeader{
		background-color: #1dad1d !important;
		font-size: 15px;
	}
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("Reporte") . "/Reporte_ini.txt");
...
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['Reporte']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['Reporte'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
if (is_file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("app_add_2fa") . "/app_add_2fa_ini.txt"))
{
    $sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("app_add_2fa") . "/app_add_2fa_ini.txt");
    if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
...
if (is_file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("app_settings") . "/app_settings_ini.txt"))
{
    $sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("app_settings") . "/app_settings_ini.txt");
    if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
...
if (is_file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_public_areas") . "/grid_public_areas_ini.txt"))
{
    $sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_public_areas") . "/grid_public_areas_ini.txt");
    if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_public_areas']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['grid_public_areas'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_public_cursos") . "/grid_public_cursos_ini.txt"))
{
    $sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_public_cursos") . "/grid_public_cursos_ini.txt");
    if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_public_cursos']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['grid_public_cursos'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_public_instructor") . "/grid_public_instructor_ini.txt"))
{
    $sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_public_instructor") . "/grid_public_instructor_ini.txt");
    if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_public_instructor']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['grid_public_instructor'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_public_cursos_por_instructor") . "/grid_public_cursos_por_instructor_ini.txt"))
{
    $sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_public_cursos_por_instructor") . "/grid_public_cursos_por_instructor_ini.txt");
    if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_public_cursos_por_instructor']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['grid_public_cursos_por_instructor'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_public_aspirantes") . "/grid_public_aspirantes_ini.txt"))
{
    $sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_public_aspirantes") . "/grid_public_aspirantes_ini.txt");
    if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_public_aspirantes']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['grid_public_aspirantes'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_public_aspirante_por_curso") . "/grid_public_aspirante_por_curso_ini.txt"))
{
    $sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_public_aspirante_por_curso") . "/grid_public_aspirante_por_curso_ini.txt");
    if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_public_aspirante_por_curso']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['grid_public_aspirante_por_curso'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[2]))
{
 ...
 $nm_var_lab[3] = "Cursos por Instructores";
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[4]))
{
 ...
 $nm_var_lab[5] = "Aspirante por curso";
...
$app_menu_menuData['data'] .= "item_1|.|" . $this->Nm_lang['lang_menu_security'] . "||" . $this->Nm_lang['lang_menu_security'] . "|grp__NM__ico__NM__StreamlineSharpPadlockShieldSolid.png|_self|\n";
...
{
    $app_menu_menuData['data'] .= "item_2|..|" . $this->Nm_lang['lang_list_users'] . "||||_self|disabled\n";
}
...
{
    $app_menu_menuData['data'] .= "item_11|..|" . $this->Nm_lang['lang_list_users_x_groups'] . "|app_menu_form_php.php?sc_item_menu=item_11&sc_apl_menu=app_grid_sec_users_groups&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_list_users_x_groups'] . "||" . $this->app_menu_target('_self') . "|" . "\n";
}
else
{
    $app_menu_menuData['data'] .= "item_11|..|" . $this->Nm_lang['lang_list_users_x_groups'] . "||||_self|disabled\n";
}
...
{
    $app_menu_menuData['data'] .= "item_12|..|" . $this->Nm_lang['lang_2fa'] . "|app_menu_form_php.php?sc_item_menu=item_12&sc_apl_menu=app_add_2fa&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_2fa'] . "||" . $this->app_menu_target('_self') . "|" . "\n";
}
else
{
    $app_menu_menuData['data'] .= "item_12|..|" . $this->Nm_lang['lang_2fa'] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['app_settings']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_settings']) == "on")
{
    $app_menu_menuData['data'] .= "item_13|..|" . $this->Nm_lang['lang_settings'] . "|app_menu_form_php.php?sc_item_menu=item_13&sc_apl_menu=app_settings&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[0] . "||" . $this->app_menu_target('_self') . "|" . "\n";
}
else
{
    $app_menu_menuData['data'] .= "item_13|..|" . $this->Nm_lang['lang_settings'] . "||||_self|disabled\n";
}
...
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_public_areas']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_public_areas']) == "on")
{
    $app_menu_menuData['data'] .= "item_14|.|" . $nm_var_lab[0] . "|app_menu_form_php.php?sc_item_menu=item_14&sc_apl_menu=grid_public_areas&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[1] . "||" . $this->app_menu_target('_self') . "|" . "\n";
}
else
{
    $app_menu_menuData['data'] .= "item_14|.|" . $nm_var_lab[0] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_public_cursos']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_public_cursos']) == "on")
{
    $app_menu_menuData['data'] .= "item_15|.|" . $nm_var_lab[1] . "|app_menu_form_php.php?sc_item_menu=item_15&sc_apl_menu=grid_public_cursos&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[2] . "||" . $this->app_menu_target('_self') . "|" . "\n";
}
else
{
    $app_menu_menuData['data'] .= "item_15|.|" . $nm_var_lab[1] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_public_instructor']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_public_instructor']) == "on")
{
    $app_menu_menuData['data'] .= "item_16|.|" . $nm_var_lab[2] . "|app_menu_form_php.php?sc_item_menu=item_16&sc_apl_menu=grid_public_instructor&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[3] . "||" . $this->app_menu_target('_self') . "|" . "\n";
}
else
{
    $app_menu_menuData['data'] .= "item_16|.|" . $nm_var_lab[2] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_public_cursos_por_instructor']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_public_cursos_por_instructor']) == "on")
{
    $app_menu_menuData['data'] .= "item_17|.|" . $nm_var_lab[3] . "|app_menu_form_php.php?sc_item_menu=item_17&sc_apl_menu=grid_public_cursos_por_instructor&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[4] . "||" . $this->app_menu_target('_self') . "|" . "\n";
}
else
{
    $app_menu_menuData['data'] .= "item_17|.|" . $nm_var_lab[3] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_public_aspirantes']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_public_aspirantes']) == "on")
{
    $app_menu_menuData['data'] .= "item_18|.|" . $nm_var_lab[4] . "|app_menu_form_php.php?sc_item_menu=item_18&sc_apl_menu=grid_public_aspirantes&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[5] . "||" . $this->app_menu_target('_self') . "|" . "\n";
}
else
{
    $app_menu_menuData['data'] .= "item_18|.|" . $nm_var_lab[4] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_public_aspirante_por_curso']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_public_aspirante_por_curso']) == "on")
{
    $app_menu_menuData['data'] .= "item_19|.|" . $nm_var_lab[5] . "|app_menu_form_php.php?sc_item_menu=item_19&sc_apl_menu=grid_public_aspirante_por_curso&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[6] . "||" . $this->app_menu_target('_self') . "|" . "\n";
}
else
{
    $app_menu_menuData['data'] .= "item_19|.|" . $nm_var_lab[5] . "||||_self|disabled\n";
}
$app_menu_menuData['data'] .= "item_21|.|" . $nm_var_lab[6] . "||" . $nm_var_hint[7] . "|grp__NM__menu_img__NM__Sin t+­tulo1.png|_self|\n";
...
$str_disabled = "N";
$str_link = "#";
$str_icon = "grp__NM__ico__NM__StreamlineSharpPadlockShieldSolid.png";
$icon_aba = "";
$icon_aba_inactive = "";
...
$str_disabled = "N";
$str_link = "app_menu_form_php.php?sc_item_menu=item_12&sc_apl_menu=app_add_2fa&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app_add_2fa']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_add_2fa']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "app_menu_form_php.php?sc_item_menu=item_13&sc_apl_menu=app_settings&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app_settings']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_settings']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "app_menu_form_php.php?sc_item_menu=item_14&sc_apl_menu=grid_public_areas&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_public_areas']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_public_areas']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "app_menu_form_php.php?sc_item_menu=item_15&sc_apl_menu=grid_public_cursos&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_public_cursos']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_public_cursos']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "app_menu_form_php.php?sc_item_menu=item_16&sc_apl_menu=grid_public_instructor&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_public_instructor']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_public_instructor']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "app_menu_form_php.php?sc_item_menu=item_17&sc_apl_menu=grid_public_cursos_por_instructor&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_public_cursos_por_instructor']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_public_cursos_por_instructor']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "app_menu_form_php.php?sc_item_menu=item_18&sc_apl_menu=grid_public_aspirantes&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_public_aspirantes']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_public_aspirantes']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "app_menu_form_php.php?sc_item_menu=item_19&sc_apl_menu=grid_public_aspirante_por_curso&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_public_aspirante_por_curso']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_public_aspirante_por_curso']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "#";
$str_icon = "grp__NM__menu_img__NM__Sin t+­tulo1.png";
$icon_aba = "";
$icon_aba_inactive = "";
if(empty($str_icon) && isset($arr_menuicons['others']['active']))
{
...
<link rel="stylesheet" type="text/css" href="../_lib/css/_menuTheme/scriptcase_Fair_Blue_<?php echo ($this->menu_orientacao!='vertical')?'hor':'vert'; ?>_<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir']; ?>.css<?php if (@is_file($this->path_css . '_menuTheme/' . "scriptcase_Fair_Blue" . '_' . (($this->menu_orientacao!='vertical')?'hor':'vert') . '.css')) { echo '?scp=' . md5($this->path_css . '_menuTheme/' . "scriptcase_Fair_Blue" . '_' . (($this->menu_orientacao=='horizontal')?'hor':'vert') . '.css'); } ?>" />
<style>
   .scTabText {
   }    <?php
...
function mudaIframe(str_id)
{
    ...
    for (i = 0; i < Tab_iframes.length; i++) 
    {
        if (Tab_iframes[i] == str_id) 
        {
            ...
            {
                $('#Iframe_control').append('<iframe id="iframe_'+ Tab_iframes[i] +'" name="app_menu_'+ Tab_iframes[i] +'_iframe" frameborder="0" class="scMenuIframe" style="display: none; width: 100%; height: 100%;" src=""></iframe>');
            }
...
<div class="scMenuHHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scMenuHHeaderFont" style="float: left; text-transform: uppercase;"><?php echo "SISTEMA DE COMPLEMENTARIAS" ?></div>
    <div class="scMenuHHeaderFont" style="float: right;margin-top: -8px;">
      <span><?php echo "Bienvenido: " . $_SESSION['usr_name'] . "" ?></span>
      <br />
      <span>
<?php
...
<?php echo ($this->menu_orientacao=='vertical')?$this->nm_show_toolbarmenu($col_span, $saida_apl, $app_menu_menuData, $path_imag_cab):''; ?>  <tr class="scMenuHTableCss scMenuLine" id='idMenuLine'>
  <?php
  if($this->menu_orientacao != 'vertical')
  {
    ?>
...
<?php
$link_default = "";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['Reporte']) && $_SESSION['scriptcase']['sc_apl_seg']['Reporte'] == "on") 
{ 
    $SCR  = "";
    $link_default = " onclick=\"openMenuItem('iframe_app_menu');\" item-href=\"app_menu_form_php.php?sc_item_menu=app_menu&sc_apl_menu=Reporte&sc_apl_link=" . urlencode($app_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['app_menu']['glo_nm_usa_grupo'] . "\"  item-target=\"app_menu_iframe\"";
} 
else
{ 
...
if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
    ...
    elseif (is_file($root . $_SESSION['scriptcase']['app_menu']['glo_nm_path_imag_temp'] . "/sc_apl_default_PROYECTO_SENA.txt")) {
        $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['app_menu']['glo_nm_path_imag_temp'] . "/sc_apl_default_PROYECTO_SENA.txt"));
    }
    if (isset($apl_def)) {
        ...
        if (isset($_COOKIE['sc_actual_lang_PROYECTO_SENA'])) {
            $_SESSION['scriptcase']['app_menu']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_PROYECTO_SENA'];
        }
    }
}

  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_public_instructor_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_public_instructor_mob_form();
	}
...
?>
  ...
  // ---------- Validate nombre
  function do_ajax_form_public_instructor_mob_validate_nombre()
  {
    var nomeCampo_nombre = "nombre";
    var var_nombre = scAjaxGetFieldText(nomeCampo_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_public_instructor_mob_validate_nombre(var_nombre, var_script_case_init, do_ajax_form_public_instructor_mob_validate_nombre_cb);
  } // do_ajax_form_public_instructor_mob_validate_nombre

  function do_ajax_form_public_instructor_mob_validate_nombre_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_public_instructor_mob_validate_nombre_cb

  // ---------- Validate apellido
  function do_ajax_form_public_instructor_mob_validate_apellido()
  {
    var nomeCampo_apellido = "apellido";
    var var_apellido = scAjaxGetFieldText(nomeCampo_apellido);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_public_instructor_mob_validate_apellido(var_apellido, var_script_case_init, do_ajax_form_public_instructor_mob_validate_apellido_cb);
  } // do_ajax_form_public_instructor_mob_validate_apellido

  function do_ajax_form_public_instructor_mob_validate_apellido_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_public_instructor_mob_validate_apellido_cb

  // ---------- Validate numero_documento
  function do_ajax_form_public_instructor_mob_validate_numero_documento()
  {
    var nomeCampo_numero_documento = "numero_documento";
    var var_numero_documento = scAjaxGetFieldText(nomeCampo_numero_documento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_public_instructor_mob_validate_numero_documento(var_numero_documento, var_script_case_init, do_ajax_form_public_instructor_mob_validate_numero_documento_cb);
  } // do_ajax_form_public_instructor_mob_validate_numero_documento

  function do_ajax_form_public_instructor_mob_validate_numero_documento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_public_instructor_mob_validate_numero_documento_cb

  // ---------- Validate email
  function do_ajax_form_public_instructor_mob_validate_email()
  {
    var nomeCampo_email = "email";
    var var_email = scAjaxGetFieldText(nomeCampo_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_public_instructor_mob_validate_email(var_email, var_script_case_init, do_ajax_form_public_instructor_mob_validate_email_cb);
  } // do_ajax_form_public_instructor_mob_validate_email

  function do_ajax_form_public_instructor_mob_validate_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "email";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_public_instructor_mob_validate_email_cb

  // ---------- Validate telefono
  function do_ajax_form_public_instructor_mob_validate_telefono()
  {
    var nomeCampo_telefono = "telefono";
    var var_telefono = scAjaxGetFieldText(nomeCampo_telefono);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_public_instructor_mob_validate_telefono(var_telefono, var_script_case_init, do_ajax_form_public_instructor_mob_validate_telefono_cb);
  } // do_ajax_form_public_instructor_mob_validate_telefono

  function do_ajax_form_public_instructor_mob_validate_telefono_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_public_instructor_mob_validate_telefono_cb

  // ---------- Validate sc_field_0
  function do_ajax_form_public_instructor_mob_validate_sc_field_0()
  {
    var nomeCampo_sc_field_0 = "sc_field_0";
    var var_sc_field_0 = scAjaxGetFieldText(nomeCampo_sc_field_0);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_public_instructor_mob_validate_sc_field_0(var_sc_field_0, var_script_case_init, do_ajax_form_public_instructor_mob_validate_sc_field_0_cb);
  } // do_ajax_form_public_instructor_mob_validate_sc_field_0

  function do_ajax_form_public_instructor_mob_validate_sc_field_0_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_public_instructor_mob_validate_sc_field_0_cb

  // ---------- Validate titulo_academico
  function do_ajax_form_public_instructor_mob_validate_titulo_academico()
  {
    var nomeCampo_titulo_academico = "titulo_academico";
    var var_titulo_academico = scAjaxGetFieldSelect(nomeCampo_titulo_academico);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_public_instructor_mob_validate_titulo_academico(var_titulo_academico, var_script_case_init, do_ajax_form_public_instructor_mob_validate_titulo_academico_cb);
  } // do_ajax_form_public_instructor_mob_validate_titulo_academico

  function do_ajax_form_public_instructor_mob_validate_titulo_academico_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "titulo_academico";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_public_instructor_mob_validate_titulo_academico_cb

  // ---------- Validate activo
  function do_ajax_form_public_instructor_mob_validate_activo()
  {
    var nomeCampo_activo = "activo";
    var var_activo = scAjaxGetFieldSelect(nomeCampo_activo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_public_instructor_mob_validate_activo(var_activo, var_script_case_init, do_ajax_form_public_instructor_mob_validate_activo_cb);
  } // do_ajax_form_public_instructor_mob_validate_activo

  function do_ajax_form_public_instructor_mob_validate_activo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "activo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_public_instructor_mob_validate_activo_cb

  // ---------- Validate id_tipo_contrato
  function do_ajax_form_public_instructor_mob_validate_id_tipo_contrato()
  {
    var nomeCampo_id_tipo_contrato = "id_tipo_contrato";
    var var_id_tipo_contrato = scAjaxGetFieldSelect(nomeCampo_id_tipo_contrato);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_public_instructor_mob_validate_id_tipo_contrato(var_id_tipo_contrato, var_script_case_init, do_ajax_form_public_instructor_mob_validate_id_tipo_contrato_cb);
  } // do_ajax_form_public_instructor_mob_validate_id_tipo_contrato

  function do_ajax_form_public_instructor_mob_validate_id_tipo_contrato_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id_tipo_contrato";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_public_instructor_mob_validate_id_tipo_contrato_cb

  // ---------- Validate id_especialidad
  function do_ajax_form_public_instructor_mob_validate_id_especialidad()
  {
    var nomeCampo_id_especialidad = "id_especialidad";
    var var_id_especialidad = scAjaxGetFieldSelect(nomeCampo_id_especialidad);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_public_instructor_mob_validate_id_especialidad(var_id_especialidad, var_script_case_init, do_ajax_form_public_instructor_mob_validate_id_especialidad_cb);
  } // do_ajax_form_public_instructor_mob_validate_id_especialidad

  function do_ajax_form_public_instructor_mob_validate_id_especialidad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id_especialidad";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_public_instructor_mob_validate_id_especialidad_cb

  // ---------- Validate fecha_contratacion
  function do_ajax_form_public_instructor_mob_validate_fecha_contratacion()
  {
    var nomeCampo_fecha_contratacion = "fecha_contratacion";
    var var_fecha_contratacion = scAjaxGetFieldText(nomeCampo_fecha_contratacion);
    var var_script_case_init = document.F1.script_case_init.value;
    setTimeout(function() {
      var var_fecha_contratacion = scAjaxGetFieldText(nomeCampo_fecha_contratacion);
      x_ajax_form_public_instructor_mob_validate_fecha_contratacion(var_fecha_contratacion, var_script_case_init, do_ajax_form_public_instructor_mob_validate_fecha_contratacion_cb);
    }, 200);
  } // do_ajax_form_public_instructor_mob_validate_fecha_contratacion

  function do_ajax_form_public_instructor_mob_validate_fecha_contratacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fecha_contratacion";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_public_instructor_mob_validate_fecha_contratacion_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_public_instructor_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_public_instructor_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    var var_titulo_academico = scAjaxGetFieldSelect("titulo_academico");
    var var_activo = scAjaxGetFieldSelect("activo");
    var var_id_tipo_contrato = scAjaxGetFieldSelect("id_tipo_contrato");
    var var_id_especialidad = scAjaxGetFieldSelect("id_especialidad");
    var var_fecha_contratacion = scAjaxGetFieldText("fecha_contratacion");
    ...
    scAjaxProcOn();
    x_ajax_form_public_instructor_mob_submit_form(var_nombre, var_apellido, var_numero_documento, var_email, var_telefono, var_sc_field_0, var_titulo_academico, var_activo, var_id_tipo_contrato, var_id_especialidad, var_fecha_contratacion, var_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_public_instructor_mob_submit_form_cb);
  } // do_ajax_form_public_instructor_mob_submit_form

  function do_ajax_form_public_instructor_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("titulo_academico");
      scAjaxHideErrorDisplay("activo");
      scAjaxHideErrorDisplay("id_tipo_contrato");
      scAjaxHideErrorDisplay("id_especialidad");
      scAjaxHideErrorDisplay("fecha_contratacion");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_public_instructor_mob_submit_form_cb_after_alert);
  } // do_ajax_form_public_instructor_mob_submit_form_cb
  function do_ajax_form_public_instructor_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_public_instructor_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_public_instructor_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_public_instructor_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_public_instructor_mob_navigate_form();
    }
  }

  function perform_ajax_form_public_instructor_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_public_instructor_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_public_instructor_mob_navigate_form_cb);
  } // do_ajax_form_public_instructor_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_instructor_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_public_instructor_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_public_instructor_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_public_instructor_mob_navigate_form_cb
  function do_ajax_form_public_instructor_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_public_instructor_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_public_instructor_mob_navigate_form_cb_after_alert

  function sc_hide_form_public_instructor_mob_form()
  {
  ...
  ajax_field_list[2] = "numero_documento";
  ajax_field_list[3] = "email";
  ajax_field_list[4] = "telefono";
  ajax_field_list[5] = "sc_field_0";
  ajax_field_list[6] = "titulo_academico";
  ajax_field_list[7] = "activo";
  ajax_field_list[8] = "id_tipo_contrato";
  ajax_field_list[9] = "id_especialidad";
  ajax_field_list[10] = "fecha_contratacion";
  ...
  var ajax_error_list = {
    ...
    "apellido": {"label": "Apellido", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "numero_documento": {"label": "Numero Documento", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    ...
    "sc_field_0": {"label": "años de experiencia", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "titulo_academico": {"label": "Titulo Academico", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "activo": {"label": "Activo", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "id_tipo_contrato": {"label": "Tipo de contrato", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "id_especialidad": {"label": "Especialidad", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "fecha_contratacion": {"label": "Fecha Contratación", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0}
  };
  ...
  var ajax_field_mult = {
    ...
    "titulo_academico": new Array(),
    "activo": new Array(),
    "id_tipo_contrato": new Array(),
    "id_especialidad": new Array(),
    "fecha_contratacion": new Array()
  };
  ...
  ajax_field_mult["titulo_academico"][1] = "titulo_academico";
  ajax_field_mult["activo"][1] = "activo";
  ajax_field_mult["id_tipo_contrato"][1] = "id_tipo_contrato";
  ajax_field_mult["id_especialidad"][1] = "id_especialidad";
  ajax_field_mult["fecha_contratacion"][1] = "fecha_contratacion";
  ...
  var ajax_field_id = {
    ...
    "titulo_academico": new Array("hidden_field_label_titulo_academico", "hidden_field_data_titulo_academico"),
    "activo": new Array("hidden_field_label_activo", "hidden_field_data_activo"),
    "id_tipo_contrato": new Array("hidden_field_label_id_tipo_contrato", "hidden_field_data_id_tipo_contrato"),
    "id_especialidad": new Array("hidden_field_label_id_especialidad", "hidden_field_data_id_especialidad"),
    "fecha_contratacion": new Array("hidden_field_label_fecha_contratacion", "hidden_field_data_fecha_contratacion")
  };
  ...
  var ajax_read_only = {
    ...
    "telefono": "off",
    "sc_field_0": "off",
    "titulo_academico": "off",
    "activo": "off",
    "id_tipo_contrato": "off",
    "id_especialidad": "off",
    "fecha_contratacion": "off"
  };

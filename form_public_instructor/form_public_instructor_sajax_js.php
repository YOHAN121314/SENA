  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_public_instructor" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_public_instructor_form();
	}
...
?>
  ...
  // ---------- Validate nombre
  function do_ajax_form_public_instructor_validate_nombre()
  {
    var nomeCampo_nombre = "nombre";
    var var_nombre = scAjaxGetFieldText(nomeCampo_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_public_instructor_validate_nombre(var_nombre, var_script_case_init, do_ajax_form_public_instructor_validate_nombre_cb);
  } // do_ajax_form_public_instructor_validate_nombre

  function do_ajax_form_public_instructor_validate_nombre_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_public_instructor_validate_nombre_cb

  // ---------- Validate apellido
  function do_ajax_form_public_instructor_validate_apellido()
  {
    var nomeCampo_apellido = "apellido";
    var var_apellido = scAjaxGetFieldText(nomeCampo_apellido);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_public_instructor_validate_apellido(var_apellido, var_script_case_init, do_ajax_form_public_instructor_validate_apellido_cb);
  } // do_ajax_form_public_instructor_validate_apellido

  function do_ajax_form_public_instructor_validate_apellido_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_public_instructor_validate_apellido_cb

  // ---------- Validate numero_documento
  function do_ajax_form_public_instructor_validate_numero_documento()
  {
    var nomeCampo_numero_documento = "numero_documento";
    var var_numero_documento = scAjaxGetFieldText(nomeCampo_numero_documento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_public_instructor_validate_numero_documento(var_numero_documento, var_script_case_init, do_ajax_form_public_instructor_validate_numero_documento_cb);
  } // do_ajax_form_public_instructor_validate_numero_documento

  function do_ajax_form_public_instructor_validate_numero_documento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_public_instructor_validate_numero_documento_cb

  // ---------- Validate email
  function do_ajax_form_public_instructor_validate_email()
  {
    var nomeCampo_email = "email";
    var var_email = scAjaxGetFieldText(nomeCampo_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_public_instructor_validate_email(var_email, var_script_case_init, do_ajax_form_public_instructor_validate_email_cb);
  } // do_ajax_form_public_instructor_validate_email

  function do_ajax_form_public_instructor_validate_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "email";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_public_instructor_validate_email_cb

  // ---------- Validate telefono
  function do_ajax_form_public_instructor_validate_telefono()
  {
    var nomeCampo_telefono = "telefono";
    var var_telefono = scAjaxGetFieldText(nomeCampo_telefono);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_public_instructor_validate_telefono(var_telefono, var_script_case_init, do_ajax_form_public_instructor_validate_telefono_cb);
  } // do_ajax_form_public_instructor_validate_telefono

  function do_ajax_form_public_instructor_validate_telefono_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_public_instructor_validate_telefono_cb

  // ---------- Validate sc_field_0
  function do_ajax_form_public_instructor_validate_sc_field_0()
  {
    var nomeCampo_sc_field_0 = "sc_field_0";
    var var_sc_field_0 = scAjaxGetFieldText(nomeCampo_sc_field_0);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_public_instructor_validate_sc_field_0(var_sc_field_0, var_script_case_init, do_ajax_form_public_instructor_validate_sc_field_0_cb);
  } // do_ajax_form_public_instructor_validate_sc_field_0

  function do_ajax_form_public_instructor_validate_sc_field_0_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_public_instructor_validate_sc_field_0_cb

  // ---------- Validate titulo_academico
  function do_ajax_form_public_instructor_validate_titulo_academico()
  {
    var nomeCampo_titulo_academico = "titulo_academico";
    var var_titulo_academico = scAjaxGetFieldSelect(nomeCampo_titulo_academico);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_public_instructor_validate_titulo_academico(var_titulo_academico, var_script_case_init, do_ajax_form_public_instructor_validate_titulo_academico_cb);
  } // do_ajax_form_public_instructor_validate_titulo_academico

  function do_ajax_form_public_instructor_validate_titulo_academico_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_public_instructor_validate_titulo_academico_cb

  // ---------- Validate activo
  function do_ajax_form_public_instructor_validate_activo()
  {
    var nomeCampo_activo = "activo";
    var var_activo = scAjaxGetFieldSelect(nomeCampo_activo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_public_instructor_validate_activo(var_activo, var_script_case_init, do_ajax_form_public_instructor_validate_activo_cb);
  } // do_ajax_form_public_instructor_validate_activo

  function do_ajax_form_public_instructor_validate_activo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "activo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_public_instructor_validate_activo_cb

  // ---------- Validate id_tipo_contrato
  function do_ajax_form_public_instructor_validate_id_tipo_contrato()
  {
    var nomeCampo_id_tipo_contrato = "id_tipo_contrato";
    var var_id_tipo_contrato = scAjaxGetFieldSelect(nomeCampo_id_tipo_contrato);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_public_instructor_validate_id_tipo_contrato(var_id_tipo_contrato, var_script_case_init, do_ajax_form_public_instructor_validate_id_tipo_contrato_cb);
  } // do_ajax_form_public_instructor_validate_id_tipo_contrato

  function do_ajax_form_public_instructor_validate_id_tipo_contrato_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_public_instructor_validate_id_tipo_contrato_cb

  // ---------- Validate id_especialidad
  function do_ajax_form_public_instructor_validate_id_especialidad()
  {
    var nomeCampo_id_especialidad = "id_especialidad";
    var var_id_especialidad = scAjaxGetFieldSelect(nomeCampo_id_especialidad);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_public_instructor_validate_id_especialidad(var_id_especialidad, var_script_case_init, do_ajax_form_public_instructor_validate_id_especialidad_cb);
  } // do_ajax_form_public_instructor_validate_id_especialidad

  function do_ajax_form_public_instructor_validate_id_especialidad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_public_instructor_validate_id_especialidad_cb

  // ---------- Validate fecha_contratacion
  function do_ajax_form_public_instructor_validate_fecha_contratacion()
  {
    ...
    setTimeout(function() {
      var var_fecha_contratacion = scAjaxGetFieldText(nomeCampo_fecha_contratacion);
      x_ajax_form_public_instructor_validate_fecha_contratacion(var_fecha_contratacion, var_script_case_init, do_ajax_form_public_instructor_validate_fecha_contratacion_cb);
    }, 200);
  } // do_ajax_form_public_instructor_validate_fecha_contratacion

  function do_ajax_form_public_instructor_validate_fecha_contratacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_public_instructor_validate_fecha_contratacion_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_public_instructor_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_public_instructor_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_public_instructor_submit_form(var_nombre, var_apellido, var_numero_documento, var_email, var_telefono, var_sc_field_0, var_titulo_academico, var_activo, var_id_tipo_contrato, var_id_especialidad, var_fecha_contratacion, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_public_instructor_submit_form_cb);
  } // do_ajax_form_public_instructor_submit_form

  function do_ajax_form_public_instructor_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_public_instructor_submit_form_cb_after_alert);
  } // do_ajax_form_public_instructor_submit_form_cb
  function do_ajax_form_public_instructor_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_public_instructor_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_public_instructor_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_public_instructor_navigate_form, function() {});
    } else {
      perform_ajax_form_public_instructor_navigate_form();
    }
  }

  function perform_ajax_form_public_instructor_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_public_instructor_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_public_instructor_navigate_form_cb);
  } // do_ajax_form_public_instructor_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_public_instructor']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_public_instructor_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_public_instructor_navigate_form_cb_after_alert);
  } // do_ajax_form_public_instructor_navigate_form_cb
  function do_ajax_form_public_instructor_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_public_instructor_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_public_instructor_navigate_form_cb_after_alert

  function sc_hide_form_public_instructor_form()
  {

...
//
   ...
   $_SESSION['scriptcase']['app_settings']['glo_nm_perfil']          = "conn_postgres";
...
// 
  function conectDB()
  {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['app_settings']['glo_nm_conexao'], $this->root . $this->path_prod, 'PROYECTO_SENA', 1, $this->force_db_utf8); 
      } 
      else 
      { 
  ...
  function setConnectionHash() {
    if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['app_settings']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['app_settings']['glo_nm_conexao'])) {
      list($connectionDbms, $connectionHost, $connectionUser, $connectionPassword, $connectionDatabase) = db_conect_devel($_SESSION['scriptcase']['app_settings']['glo_nm_conexao'], $this->root . $this->path_prod, 'PROYECTO_SENA', 1, $this->force_db_utf8);
    }
    else {
...
//
    ...
    if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
        ...
        elseif (is_file($root . $_SESSION['scriptcase']['app_settings']['glo_nm_path_imag_temp'] . "/sc_apl_default_PROYECTO_SENA.txt")) {
            $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['app_settings']['glo_nm_path_imag_temp'] . "/sc_apl_default_PROYECTO_SENA.txt"));
        }
        if (isset($apl_def)) {
            ...
            if (isset($_COOKIE['sc_actual_lang_PROYECTO_SENA'])) {
                $_SESSION['scriptcase']['app_settings']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_PROYECTO_SENA'];
            }
        }
    }
